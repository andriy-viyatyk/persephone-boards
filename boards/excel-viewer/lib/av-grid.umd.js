(function(e,t){typeof exports==`object`&&typeof module<`u`?t(exports):typeof define==`function`&&define.amd?define([`exports`],t):(e=typeof globalThis<`u`?globalThis:e||self,t(e.AVGrid={}))})(this,function(e){Object.defineProperty(e,Symbol.toStringTag,{value:`Module`});function t(e,t){return typeof e==`function`?e(t):e}var n=class{_state;_defaultState;_listeners=[];_notifyScheduled=!1;_batchDepth=0;_disposed=!1;constructor(e){this._defaultState=e,this._state=e}get state(){return this._state}get(){return this._state}set=e=>{if(this._disposed)return;let n=t(e,this._state);n!==this._state&&(this._state=n,this.notify())};update=e=>{if(this._disposed)return;let t={...this._state};e(t),this._state=t,this.notify()};clear=()=>{this.set(this._defaultState)};subscribe=e=>{this._listeners.push(e);let t=!0;return()=>{if(!t)return;t=!1;let n=this._listeners.indexOf(e);n>=0&&this._listeners.splice(n,1)}};batch=e=>{this._batchDepth++;try{return e()}finally{this._batchDepth--,this._batchDepth===0&&this._notifyScheduled&&this.flush()}};flush=()=>{if(!this._notifyScheduled||this._batchDepth>0||(this._notifyScheduled=!1,this._disposed))return;let e=this._listeners.slice();for(let t of e)t(this._state)};dispose=()=>{this._disposed=!0,this._notifyScheduled=!1,this._listeners=[]};get disposed(){return this._disposed}notify(){this._notifyScheduled||(this._notifyScheduled=!0,!(this._batchDepth>0)&&queueMicrotask(()=>this.flush()))}},r=class{state;constructor(e){this.state=new n(e)}dispose(){this.state.dispose()}},i=e=>e==null,a=(e,t)=>e<=t?Array.from({length:t-e+1},(t,n)=>e+n):Array.from({length:e-t+1},(e,n)=>t+n),o=(e,t)=>{let n=new Map,r=((...r)=>{let i=JSON.stringify(r);if(n.has(i))return n.get(i);let a=e(...r),o=!t||t(a);return o instanceof Promise?o.then(e=>{e&&n.set(i,a)}):o&&n.set(i,a),a});return Object.defineProperty(r,"length",{get:()=>e.length}),r.clear=()=>n.clear(),r},s=`"`;function c(e){if(e==null)return``;if(typeof e==`string`)return e;if(typeof e==`boolean`)return e?`true`:`false`;if(typeof e==`number`)return Number.isFinite(e)?String(e):``;if(e instanceof Date)return e.toISOString();if(typeof e==`object`)try{return JSON.stringify(e)}catch{return String(e)}return String(e)}function l(e,t,n){return e.includes(s)||e.includes(t)||e.includes(`\r`)||e.includes(`
`)||n.length>0&&e.includes(n)?s+e.split(s).join(`""`)+s:e}function u(e,t,n={}){let{header:r=!0,headerNames:i,delimiter:a=`,`,rowDelimiter:o=`
`}=n,s=t.map(e=>e===void 0?`undefined`:e),u=[];if(r){let e=(i??s).map(e=>e===void 0?`undefined`:e);u.push(e.map(e=>l(e,a,o)).join(a))}for(let t of e){let e=t??{};u.push(s.map(t=>l(c(e[t]),a,o)).join(a))}return u.length?u.join(o)+o:``}function d(e,t){let n=[],r=[],i=``,a=!1,o=!1,c=()=>{r.push(i),i=``,o=!1},l=()=>{c(),(r.length!==1||r[0]!==``)&&n.push(r),r=[]},u=0;for(;u<e.length;){let n=e[u];if(a){if(n===s){if(e[u+1]===s){i+=s,u+=2;continue}a=!1,u+=1;continue}i+=n,u+=1;continue}if(n===s&&!o){a=!0,o=!0,u+=1;continue}if(t.length>0&&e.startsWith(t,u)){c(),u+=t.length;continue}if(n===`\r`){l(),u+=e[u+1]===`
`?2:1;continue}if(n===`
`){l(),u+=1;continue}i+=n,o=!0,u+=1}return l(),n}function f(e,t=!1,n=`	`,r){try{if(!e?.trim())return[];let r=d(e,n);if(!t)return r;let[i,...a]=r;return i?a.map(e=>{let t={};return i.forEach((n,r)=>{t[n]=e[r]??``}),t}):[]}catch(e){return console.error(e),r?.(e),[]}}var p=o(e=>(t,n)=>{let r=e?t[e]:t,a=e?n[e]:n;return i(r)===i(a)?typeof r==`number`&&typeof a==`number`?r-a:typeof r==`string`&&typeof a==`string`?r.localeCompare(a):r instanceof Date&&a instanceof Date?r.getTime()-a.getTime():typeof r==`boolean`&&typeof a==`boolean`?r===a?0:r?1:-1:0:i(r)?-1:1});function m(e,t=`text`){if(i(e))return``;switch(t){case`text`:if(e instanceof Date)return e.toLocaleString();if(e||typeof e==`boolean`)return e.toString();break;case`date`:case`dateTime`:if(e instanceof Date)return t===`date`?e.toLocaleDateString():e.toLocaleString();if(typeof e==`string`){let n=new Date(e);return Number.isNaN(n.getTime())?``:t===`date`?n.toLocaleDateString():n.toLocaleString()}break;case`phone`:if(typeof e==`string`)return e.length===10?`(${e.substring(0,3)}) ${e.substring(3,6)}-${e.substring(6)}`:e}return``}function h(e,t){let{filter:n,column:r}=t;return r?.formatValue?r.formatValue(r,e):e[n.columnKey]}function g(e,t){let n=typeof e==`object`&&e&&!(e instanceof Date)&&`value`in e?e.value:e;return t instanceof Date&&n instanceof Date?n.getTime()===t.getTime():n===t}function _(e,t){let n=!0;if(t?.length)for(let r of t){let t=r.filter,i=r.column,a=i?.filter;if(a){let r=t.value;if(r!=null&&!a.match(r,e,i)&&(n=!1),!n)break;continue}let o=h(e,r);switch(t.type??`options`){case`options`:{let e=t;e.value?.length&&(e.value.some(e=>g(e,o))||(n=!1));break}}if(!n)break}return n}function v(e,t,n){return!n||t.some(t=>{let r=w(t,e)?.toString().toLowerCase();return!!r&&r.indexOf(n)>=0})}var y=[];function b(e){if(!e)return y;let t=e.toLowerCase().split(/\s+/).filter(Boolean);return t.length?t:y}function x(e,t,n,r){if(!n?.length&&!r?.length)return e;let i=b(n),a=r?.length?r.map(e=>({filter:e,column:t.find(t=>String(t.key)===e.columnKey)})):void 0;return e.filter(e=>e?(!i.length||i.every(n=>v(e,t,n)))&&(!a?.length||_(e,a)):!1)}function S(e){return!!(e&&typeof e==`string`&&(e.toLowerCase()===`false`||e.toLowerCase()===`no`))}function C(e){return!!(e&&!S(e))}function w(e,t){return e.formatValue?e.formatValue(e,t):e.displayFormat?m(t[e.key],e.displayFormat):t[e.key]}function T(e,t,n,r){if(!e?.length||!t?.length)return;let i=t.map(e=>e.name??String(e.key)),a=t.map((e,t)=>String(t));return u(e.map(e=>t.reduce((t,n,r)=>(t[a[r]]=w(n,e),t),{})),a,{header:n,headerNames:i,delimiter:r===!0?`	`:r})}function E(e,t,n){switch(e.dataType){case`boolean`:return typeof n==`string`&&(n.toLowerCase()===`false`||n.toLowerCase()===`no`||n.toLowerCase()===`0`)?!1:!!n;case`number`:{let e=Number(n);return isNaN(e)?null:e}default:return n&&Array.isArray(e.options)?e.options.find(e=>e===n)?n:void 0:n}}var D=`<span class="avg-search-match">`,ee=`<span class="avg-search-text">`,O=`</span>`;function k(e){return e.indexOf(`&`)<0&&e.indexOf(`<`)<0&&e.indexOf(`>`)<0?e:e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function A(e,t){return(t.length?ne(e,t):null)??k(e)}function j(e,t){return A(e==null?``:String(e),b(t))}function te(e,t,n){return D+k(e.slice(t,n))+O}function ne(e,t){if(!e)return null;let n=e.toLowerCase(),r=null;for(let e of t){if(!e)continue;let t=n.indexOf(e);for(;t>=0;)(r??=[]).push([t,t+e.length]),t=n.indexOf(e,t+e.length)}if(!r)return null;r.length>1&&r.sort((e,t)=>e[0]-t[0]);let i=``,a=0,o=-1,s=-1;for(let t of r){if(t[0]<=s){t[1]>s&&(s=t[1]);continue}o>=0&&(i+=k(e.slice(a,o))+te(e,o,s),a=s),o=t[0],s=t[1]}return i+=k(e.slice(a,o))+te(e,o,s),i+=k(e.slice(s)),ee+i+O}var M=class{listeners=[];send=e=>{let t=this.listeners.slice();for(let n of t)n(e)};subscribe=e=>{this.listeners.push(e);let t=!0;return{unsubscribe:()=>{if(!t)return;t=!1;let n=this.listeners.indexOf(e);n>=0&&this.listeners.splice(n,1)}}};clear=()=>{this.listeners=[]};get listenerCount(){return this.listeners.length}},re={rows:!1,columns:!1,lastIsStatusIndex:!1,rowCompare:!1,allSelected:!1,hovered:!1,editTime:!1,rowsFrozen:!1,newRowKey:!1},ie=class{onChange=new M;_changeEvent={...re};_rows;_columns;_lastIsStatusIndex=-1;_rowCompare;_sortValue;_allSelected=!1;_hovered={row:-1,col:-1};_editTime=0;_rowsFrozen=!1;_newRowKey;searchWords=[];constructor(e,t){this._rows=e,this._columns=t}change=e=>{let t={...e,...this._changeEvent};(e||Object.getOwnPropertyNames(t).some(e=>t[e]))&&(this._changeEvent={...re},this.onChange.send(t))};get rows(){return this._rows}set rows(e){this._rows!==e&&(this._rows=e,this._changeEvent.rows=!0)}get columns(){return this._columns}set columns(e){this._columns!==e&&(this._columns=e,this._changeEvent.columns=!0)}get lastIsStatusIndex(){return this._lastIsStatusIndex}set lastIsStatusIndex(e){this._lastIsStatusIndex!==e&&(this._lastIsStatusIndex=e,this._changeEvent.lastIsStatusIndex=!0)}get rowCompare(){return this._rowCompare}set rowCompare(e){this._rowCompare!==e&&(this._rowCompare=e,this._changeEvent.rowCompare=!0)}get sortValue(){return this._sortValue}set sortValue(e){this._sortValue!==e&&(this._sortValue=e,this._changeEvent.rowCompare=!0)}get allSelected(){return this._allSelected}set allSelected(e){this._allSelected!==e&&(this._allSelected=e,this._changeEvent.allSelected=!0)}get hovered(){return this._hovered}set hovered(e){this._hovered!==e&&(this._hovered=e,this._changeEvent.hovered=!0)}get editTime(){return this._editTime}set editTime(e){this._editTime!==e&&(this._editTime=e,this._changeEvent.editTime=!0)}get rowsFrozen(){return this._rowsFrozen}set rowsFrozen(e){this._rowsFrozen!==e&&(this._rowsFrozen=e,this._changeEvent.rowsFrozen=!0)}get newRowKey(){return this._newRowKey}set newRowKey(e){this._newRowKey!==e&&(this._newRowKey=e,this._changeEvent.newRowKey=!0)}},ae=class{onClick=new M;onDoubleClick=new M;onMouseDown=new M;onContextMenu=new M;onSelectMove=new M;onSelectEnd=new M},oe=class{onMouseLeave=new M;onKeyDown=new M;onContextMenu=new M;onBlur=new M},se=class{cell=new ae;content=new oe;onColumnResize=new M;onColumnsReorder=new M;onRowsAdded=new M;onRowsDeleted=new M;onSortColumn=new M;onFiltersChanged=new M;clear(){for(let e of[this.cell,this.content])for(let t of Object.values(e))t.clear();this.onColumnResize.clear(),this.onColumnsReorder.clear(),this.onRowsAdded.clear(),this.onRowsDeleted.clear(),this.onSortColumn.clear(),this.onFiltersChanged.clear()}},N=e=>`<svg viewBox="0 0 16 16" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${e}</svg>`,ce=N(`<path d="M8 3v10M4.5 9.5 8 13l3.5-3.5"/>`),le=N(`<path d="M8 13V3M4.5 6.5 8 3l3.5 3.5"/>`),ue=N(`<path d="M2.5 3h11l-4.2 5v4.5L6.7 13.5V8z"/>`),de=N(`<path d="M3 8.5 6.5 12 13 4.5"/>`),fe=N(`<rect x="1.75" y="1.75" width="12.5" height="12.5" rx="2.5"/><path d="M4.5 8.2 7 10.7l4.5-5"/>`),pe=N(`<rect x="1.75" y="1.75" width="12.5" height="12.5" rx="2.5"/>`),me=N(`<path d="M13 6 6 13M13 10.5l-2.5 2.5"/>`),he=N(`<path d="M4 4l8 8M12 4l-8 8"/>`),ge=N(`<path d="M4 6.5 8 10.5l4-4"/>`),_e=N(`<path d="M4 10.5 8 6.5l4 4"/>`),ve=N(`<path d="M6 4l4 4-4 4"/>`),ye=N(`<rect x="5.75" y="5.75" width="8.5" height="8.5" rx="1.5"/><path d="M11 3.75H3.75c-.55 0-1 .45-1 1V11"/>`),be=N(`<path d="M6 2.75h4v2H6z"/><path d="M10 3.75h1.75c.55 0 1 .45 1 1v8.5c0 .55-.45 1-1 1h-7.5c-.55 0-1-.45-1-1v-8.5c0-.55.45-1 1-1H6"/>`),P=N(`<path d="M8 3.5v9M3.5 8h9"/>`),xe=N(`<path d="M3 4.5h10M6.5 4.5V3h3v1.5M4.5 4.5l.6 8.5h5.8l.6-8.5M6.75 7v3.5M9.25 7v3.5"/>`),Se=N(`<rect x="1.75" y="1.75" width="12.5" height="12.5" rx="2.5"/><path d="M4.5 8h7"/>`),Ce=`--select-column--`,we=`<span class="avg-select-box avg-checked">${fe}</span>`,Te=`<span class="avg-select-box">${pe}</span>`,Ee=`<span class="avg-select-box avg-checked">${Se}</span>`;function De(e){return{key:Ce,name:``,width:32,isStatusColumn:!0,resizable:!1,readonly:!0,align:`center`,headerRender:()=>{switch(e.models.selected.selectAllState){case`all`:return we;case`some`:return Ee;default:return Te}},render:t=>e.models.selected.isSelected(t.rowKey)?we:Te}}var Oe=140,ke=class{model;_selectColumn;constructor(e){this.model=e,this.model.events.onColumnResize.subscribe(this.onColumnResize),this.model.events.onColumnsReorder.subscribe(this.onColumnsReorder)}get columnCount(){return this.model.data.columns.length}get firstEditable(){let e=this.model.data.columns.findIndex(e=>!e.readonly&&!e.isStatusColumn);return e===-1?void 0:{col:this.model.data.columns[e],index:e}}getColumnWidth=e=>this.model.data.columns[e]?.width??140;indexOfKey=e=>this.model.data.columns.findIndex(t=>String(t.key)===e);setColumns=e=>{this.model.options.columns=e,this.updateColumnsData(e),this.model.options.onColumnsChange?.(e)};updateColumns=e=>{this.setColumns(e(this.model.options.columns))};get selectColumn(){return this._selectColumn||=De(this.model),this._selectColumn}updateColumnsData=e=>{let t=this.model.options.selectColumn?[this.selectColumn,...e]:e,n=-1;t.forEach((e,t)=>{e.isStatusColumn&&(n=t)}),this.model.data.lastIsStatusIndex=n,this.model.data.columns=t.filter(e=>!e.hidden),this.model.data.change()};onColumnResize=({columnKey:e,width:t})=>{t<20||(this.updateColumns(n=>n.map(n=>String(n.key)===e?{...n,width:t}:n)),this.model.options.onColumnResize?.(e,t))};onColumnsReorder=({sourceKey:e,targetKey:t})=>{e!==t&&(this.updateColumns(n=>{let r=n.findIndex(t=>String(t.key)===e),i=n.findIndex(e=>String(e.key)===t);if(r<0||i<0)return n;let o=[...n];return o.splice(i,0,o.splice(r,1)[0]),this.model.update({columns:a(r,i)}),o}),this.model.options.onColumnsReorder?.(e,t))}},Ae={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`};function je(e){return e.replace(/[&<>"]/g,e=>Ae[e])}var Me=`font-family:sans-serif;font-size:12px;border:solid 1px #c0c0c0;border-collapse:collapse`,Ne=`border:none;border-bottom:solid 1px #c0c0c0;text-align:left;padding:2px 4px`,Pe=class{model;constructor(e){this.model=e,this.model.events.content.onKeyDown.subscribe(this.onContentKeyDown)}get enabled(){return this.model.options.disableClipboard!==!0}copyColumns(e){let t=e.colRange[0];return e.columns.map((e,n)=>({column:e,index:t+n})).filter(e=>!e.column.isStatusColumn)}cellText(e,t,n,r){if(e.copyValue)return e.copyValue(this.cellContext(e,t,n,r));if(e.formatValue||e.displayFormat||!e.render)return w(e,t);let i=e.render(this.cellContext(e,t,n,r));return i==null?``:typeof i==`string`?i.includes(`<`)?this.textOf(i):i:i.textContent??``}cellContext(e,t,n,r){return{value:t[e.key],row:t,column:e,rowIndex:n,colIndex:r,rowKey:this.model.options.getRowKey(t),highlight:this.model.highlightText}}textOf(e){let t=this.model.renderModel?.gridRef.current?.ownerDocument??document,n=this.scratch??=t.createElement(`div`);return n.innerHTML=e,n.textContent??``}scratch;selectionText(e=`copy`){let t=this.model.models.focus.getGridSelection();if(!t)return``;let n=this.copyColumns(t),r=t.rows;if(!n.length||!r.length)return``;let i=t.rowRange[0];if(e===`copyAsJson`)return JSON.stringify(r.map((e,t)=>{let r={};for(let{column:a,index:o}of n)r[String(a.key)]=this.cellText(a,e,i+t,o);return r}),null,4);if(r.length===1&&n.length===1&&e===`copy`){let e=this.cellText(n[0].column,r[0],i,n[0].index);return e==null?``:String(e)}let a=n.map((e,t)=>String(t));return u(r.map((e,t)=>{let r={};return n.forEach(({column:n,index:o},s)=>{r[a[s]]=this.cellText(n,e,i+t,o)}),r}),a,{header:e===`copyWithHeaders`,headerNames:n.map(({column:e})=>e.name??String(e.key)),delimiter:`	`})}selectionHtml(){let e=this.model.models.focus.getGridSelection();if(!e)return``;let t=this.copyColumns(e);if(!t.length||!e.rows.length)return``;let n=e.rowRange[0],r=(e,t)=>`<td style="${Ne};font-weight:${t}">${je(e==null?``:String(e))}</td>`;return`<table style="${Me}"><thead>${`<tr>${t.map(({column:e})=>r(e.name??String(e.key),600)).join(``)}</tr>`}</thead><tbody>${e.rows.map((e,i)=>`<tr>${t.map(({column:t,index:a})=>r(this.cellText(t,e,n+i,a),400)).join(``)}</tr>`).join(``)}</tbody></table>`}writeToEvent(e,t=`copy`){let n=e.clipboardData;if(!n)return!1;let r=this.selectionText(t);return r?(n.setData(`text/plain`,r),t===`copyAsHtmlTable`&&n.setData(`text/html`,this.selectionHtml()),!0):!1}async copySelection(e=`copy`){let t=this.selectionText(e);if(!t)return!1;if(e===`copyAsHtmlTable`){let e=this.selectionHtml(),n=navigator.clipboard;if(n?.write&&typeof ClipboardItem<`u`)try{return await n.write([new ClipboardItem({"text/html":new Blob([e],{type:`text/html`}),"text/plain":new Blob([t],{type:`text/plain`})})]),!0}catch{}}try{return await navigator.clipboard?.writeText(t),!0}catch{return this.copyByExecCommand(t)}}copyByExecCommand(e){let t=this.model.renderModel?.gridRef.current?.ownerDocument??document,n=t.createElement(`textarea`);n.value=e,n.style.cssText=`position:fixed;top:-9999px;opacity:0`,n.setAttribute(`aria-hidden`,`true`),t.body.appendChild(n);try{return n.select(),t.execCommand?.(`copy`)??!1}catch{return!1}finally{n.remove(),this.model.focusGrid()}}async cut(){if(!this.model.options.editable)return this.copySelection();let e=await this.copySelection();return e&&this.model.models.editing.deleteRange(),e}pasteFromEvent(e){let t=e.clipboardData?.getData(`text/plain`);return t?this.pasteText(t):!1}async paste(){try{let e=await navigator.clipboard?.readText();return e?this.pasteText(e):!1}catch{return!1}}pasteText(e){if(!e)return!1;let t=f(e);if(!t.length&&e.length&&(t=[[e]]),!t.length||!t[0].length)return!1;let n=this.pasteTarget(t.length,t[0].length);if(!n)return!1;let r=!1;for(let e=n.rowStart,i=0;e<=n.rowEnd;e++){for(let a=n.colStart,o=0;a<=n.colEnd;a++){let n=t[i]?.[o];this.model.models.editing.editCellAt(e,a,n,!0)&&(r=!0),o=(o+1)%t[0].length}i=(i+1)%t.length}return n.expanded&&this.model.models.focus.selectRange(n.rowStart,n.colStart,n.rowEnd,n.colEnd),r&&this.model.update({all:!0}),r}pasteTarget(e,t){let n=this.model.models.focus.getGridSelection();if(!n)return;let[r,i]=n.rowRange,[a,o]=n.colRange;if(r!==i||a!==o)return{rowStart:r,rowEnd:i,colStart:a,colEnd:o,expanded:!1};let s=this.model.models.structure,c=r+e-this.model.data.rows.length;c>0&&s.canAddRows&&s.addBlankRows(c,void 0,!1);let l=a+t-this.model.data.columns.length;return l>0&&s.canAddColumns&&s.addBlankColumns(l),{rowStart:r,colStart:a,rowEnd:Math.min(r+e-1,this.model.data.rows.length-1),colEnd:Math.min(a+t-1,this.model.data.columns.length-1),expanded:!0}}onContentKeyDown=e=>{this.enabled&&(!e.ctrlKey||!e.shiftKey||e.code!==`KeyC`||this.model.models.focus.focus&&(e.preventDefault(),this.copySelection(`copyWithHeaders`)))}},Fe={rowKey:``,columnKey:``,value:void 0,openedBy:`key`,changed:!1},Ie=new Set([`Enter`,`NumpadEnter`,`F2`]),Le=class{model;createEditor;editor;editRow=-1;editCol=-1;closing=!1;constructor(e){this.model=e,this.model.events.content.onKeyDown.subscribe(this.onContentKeyDown),this.model.events.cell.onDoubleClick.subscribe(this.onCellDoubleClick),this.model.events.cell.onMouseDown.subscribe(this.onCellMouseDown)}get isEditing(){return this.editRow>=0}get edit(){return this.isEditing?this.model.state.get().cellEdit:void 0}isEditingCell=(e,t)=>e===this.editRow&&t===this.editCol&&this.editRow>=0;canEdit(e){return!!(this.model.options.editable&&e&&!e.readonly&&!e.isStatusColumn)}togglesInsteadOfEditing(e){return e?.dataType===`boolean`&&!e.editor}openEdit=(e,t,n,r=n===void 0?`key`:`typing`,i)=>{let a=this.model.data.columns[t],o=this.model.data.rows[e];if(o===void 0||!this.canEdit(a)||this.togglesInsteadOfEditing(a))return;this.isEditing&&this.closeEdit(!0,!1);let s=n===void 0?o[a.key]:n;this.model.state.update(e=>{e.cellEdit={rowKey:this.model.options.getRowKey(o),columnKey:a.key,value:s,openedBy:r,pointerX:i,changed:n!==void 0}}),this.editRow=e,this.editCol=t,this.editor=void 0,this.model.models.rows.freezeRows(),this.markCell(e,t)};closeEdit=(e,t=!0)=>{if(!this.isEditing||this.closing)return;this.closing=!0;let n=this.model.state.get().cellEdit,r=this.editRow,i=this.editCol;this.detachEditor(),this.model.state.update(e=>{e.cellEdit={...Fe}}),this.editRow=-1,this.editCol=-1,e&&n.changed&&this.editCellAt(r,i,n.value,!0),this.markRow(r),this.closing=!1,t&&this.model.focusGrid()};commitEdit=()=>this.closeEdit(!0);cancelEdit=()=>this.closeEdit(!1);onFocusMoved=()=>{if(!this.isEditing)return;let e=this.model.models.focus.focus,t=this.model.state.get().cellEdit;t&&(e&&e.columnKey===t.columnKey&&e.rowKey===t.rowKey||this.closeEdit(!0,!1))};editCellAt=(e,t,n,r=!1)=>{let i=this.model.data.columns[t],a=this.model.data.rows[e];if(a===void 0||!this.canEdit(i))return!1;let o=a[i.key],s=i.validate?i.validate(i,a,n):this.coerce(i,a,n,o);return s===void 0&&n!==void 0&&n!==``?(this.model.options.onInvalidEdit?.({value:n,row:a,column:i,rowIndex:e,colIndex:t}),!1):o===s||this.model.options.onEdit?.({value:s,previousValue:o,row:a,column:i,columnKey:String(i.key),rowKey:this.model.options.getRowKey(a),rowIndex:e,colIndex:t})===!1?!1:(this.model.models.rows.freezeRows(),a[i.key]=s,this.model.data.newRowKey===this.model.options.getRowKey(a)&&(this.model.data.newRowKey=void 0,this.model.data.change()),r||this.markRow(e),!0)};coerce(e,t,n,r){return e.dataType===void 0&&typeof r==`number`&&typeof n==`string`&&n.trim()!==``&&Number.isFinite(Number(n))?Number(n):E(e,t,n)}deleteRange=()=>{let e=this.model.models.focus.getGridSelection();if(!e)return;let t=!1,[n,r]=e.rowRange,[i,a]=e.colRange;for(let e=i;e<=a;e++)if(this.canEdit(this.model.data.columns[e]))for(let i=n;i<=r;i++)this.editCellAt(i,e,void 0,!0)&&(t=!0);t&&this.model.update({all:!0})};toggleBooleanCell=(e,t)=>{let n=this.model.data.columns[t],r=this.model.data.rows[e];r===void 0||!this.canEdit(n)||n.dataType===`boolean`&&(this.editCellAt(e,t,!C(r[n.key])),this.model.focusGrid())};toggleBooleans=e=>{let t=this.model.models.focus.getGridSelection();if(!t||!t.columns.every(e=>e.dataType===`boolean`))return;let[n,r]=t.rowRange,[i,a]=t.colRange,o=this.model.data.columns[t.focusCol],s=this.model.data.rows[t.focusRow];if(!o||s===void 0)return;let c=!C(s[o.key]),l=!1;for(let t=i;t<=a;t++){let i=this.model.data.columns[t];if(this.canEdit(i))for(let a=n;a<=r;a++){let n=this.model.data.rows[a];if(n===void 0)continue;let r=e?c:!C(n[i.key]);this.editCellAt(a,t,r,!0)&&(l=!0)}}l&&this.model.update({all:!0})};editorElement(){if(!this.isEditing)return;if(this.editor)return this.editor.element;let e=this.model.data.columns[this.editCol],t=this.model.data.rows[this.editRow],n=this.model.state.get().cellEdit;if(!e||t===void 0||!n)return;let r={value:n.value,row:t,column:e,rowIndex:this.editRow,colIndex:this.editCol,rowKey:n.rowKey,openedBy:n.openedBy??`key`,pointerX:n.pointerX,setValue:this.setEditValue,commit:this.commitEdit,cancel:this.cancelEdit,commitAndPass:this.commitAndPass},i;if(e.editor){let t=e.editor(r);i=t instanceof HTMLElement?{element:t}:t}else if(this.createEditor)i=this.createEditor(r);else return;return this.adopt(i),this.editor={...i,focus:i.focus??(()=>i.element.focus())},this.editor.element}adopt(e){let t=e.element;t.classList.add(`avg-cell-editor`),t.hasAttribute(`data-type`)||t.setAttribute(`data-type`,`cell-editor`),t.addEventListener(`keydown`,this.onEditorKeyDown)}onEditorKeyDown=e=>{!this.isEditing||e.defaultPrevented||(e.key===`Escape`?(e.preventDefault(),this.cancelEdit()):e.key===`Tab`&&(e.preventDefault(),this.commitAndPass(e)))};editorMounted(){let e=this.editor;e&&queueMicrotask(()=>{this.editor===e&&e.element.isConnected&&e.focus()})}ownsCell(e){return this.editor!==void 0&&this.editor.element.parentElement===e}releaseCell(){queueMicrotask(()=>this.closeEdit(!0,!1))}onViewportScrolled=()=>{if(!this.isEditing)return;let e=this.model.renderModel?.renderInfo.current.rendered;if(!e)return;let t=this.model.dataRowToGridRow(this.editRow);(t<e.top||t>e.bottom)&&this.closeEdit(!0,!1)};setEditValue=e=>{this.model.state.update(t=>{t.cellEdit&&={...t.cellEdit,value:e,changed:!0}})};commitAndPass=e=>{this.closeEdit(!0),this.model.events.content.onKeyDown.send(e)};detachEditor(){let e=this.editor;this.editor=void 0,e?.destroy?.(),e?.element.removeEventListener(`keydown`,this.onEditorKeyDown),e?.element.remove()}markCell(e,t){e<0||t<0||this.model.update({cells:[{row:this.model.dataRowToGridRow(e),col:t}]})}markRow(e){e<0||this.model.update({rows:[this.model.dataRowToGridRow(e)]})}onCellMouseDown=e=>{!e.wasFocused||e.e.button!==0||e.e.shiftKey||e.e.ctrlKey||e.e.altKey||e.e.metaKey||!this.canEdit(e.col)||this.togglesInsteadOfEditing(e.col)||this.isEditingCell(e.rowIndex,e.colIndex)||this.openEdit(e.rowIndex,e.colIndex,void 0,`pointer`,e.e.clientX)};onCellDoubleClick=e=>{if(this.canEdit(e.col)){if(this.togglesInsteadOfEditing(e.col)){this.toggleBooleans(!1);return}this.isEditingCell(e.rowIndex,e.colIndex)||this.openEdit(e.rowIndex,e.colIndex,void 0,`pointer`,e.e?.clientX)}};onContentKeyDown=e=>{if(!this.model.options.editable)return;let t=this.model.models.focus.getGridFocus();if(!t)return;let{column:n,rowIndex:r,colIndex:i}=t;if(Ie.has(e.code)){e.preventDefault(),this.togglesInsteadOfEditing(n)?this.toggleBooleans(!0):this.model.models.focus.singleCellSelected&&this.openEdit(r,i);return}if(e.code===`Space`&&n.dataType===`boolean`){e.preventDefault(),this.togglesInsteadOfEditing(n)?this.toggleBooleans(!1):this.model.models.focus.singleCellSelected&&this.openEdit(r,i);return}if(e.code===`Delete`&&!e.ctrlKey){e.preventDefault(),this.deleteRange();return}if(e.code===`Escape`){this.closeEdit(!1);return}e.key.length===1&&!e.ctrlKey&&!e.altKey&&!e.metaKey&&!this.togglesInsteadOfEditing(n)&&this.model.models.focus.singleCellSelected&&(e.preventDefault(),this.openEdit(r,i,e.key))}},Re={charWidth:8,padding:20,minWidth:60,maxWidth:300,sampleSize:100};function ze(e,t,n,r){let i=r?.sampleSize??Re.sampleSize,a=Math.min(e.length,i),o=[];for(let n=0;n<a;n++)o.push(e[n]?.[t]);return Be(o,n,r)}function Be(e,t,n){let{charWidth:r,padding:i,minWidth:a,maxWidth:o}={...Re,...n},s=t.length*r+i;for(let t of e){if(t==null)continue;let e=(t instanceof Date?t.toLocaleString():String(t)).length*r+i;e>s&&(s=e)}return Math.max(a,Math.min(s,o))}function Ve(e,t,n){let r={};for(let i of t)r[i]=ze(e,i,i,n);return r}var He=50,F=class extends Error{name=`AVGridError`};function I(e){throw new F(e)}function L(e){return e===null?`null`:e===void 0?`undefined`:Array.isArray(e)?`an array of ${e.length}`:`a ${typeof e}`}function Ue(e){if(typeof e==`string`){typeof document>`u`&&I(`AVGrid.create("${e}", …) needs a document to resolve the selector. Pass an element instead when running outside a browser.`);let t=document.querySelector(e);return t||I(`No element matches the selector "${e}". Check the selector, or pass the element itself: AVGrid.create(document.getElementById("grid"), { rows }).`),t}if(e&&typeof e==`object`&&typeof e.appendChild==`function`)return e;I(`AVGrid.create(container, options): container must be an element or a CSS selector, but was ${L(e)}. Pass the element the grid should fill, e.g. AVGrid.create(document.getElementById("grid"), { rows }).`)}function We(e){let t=[],n=new Set,r=Math.min(e.length,He);for(let i=0;i<r;i++){let r=e[i];if(!(!r||typeof r!=`object`))for(let e of Object.keys(r))n.has(e)||(n.add(e),t.push(e))}return t}var Ge=new Set([`id`,`url`,`uri`,`api`,`ip`,`sql`,`css`,`html`]);function Ke(e){let t=e.replace(/[_-]+/g,` `).replace(/([a-z0-9])([A-Z])/g,`$1 $2`).trim();return t?t.split(/\s+/).map(e=>Ge.has(e.toLowerCase())?e.toUpperCase():e.charAt(0).toUpperCase()+e.slice(1)).join(` `):e}function qe(e,t){let n=[],r=Math.min(e.length,He);for(let i=0;i<r;i++){let r=e[i]?.[t];r!=null&&n.push(r)}return n}function Je(e){let t=e.find(e=>e!=null);if(t===void 0)return[];if(Array.isArray(t)){let n=t.length,r=Math.min(e.length,He);for(let t=0;t<r;t++){let r=e[t];Array.isArray(r)&&r.length>n&&(n=r.length)}return Array.from({length:n},(t,n)=>({key:String(n),name:String(n+1),width:ze(e,String(n),String(n+1))}))}return typeof t!=`object`&&I(`Cannot infer columns from rows of type ${typeof t}. Rows must be objects or arrays — or pass \`columns\` explicitly.`),We(e).map(t=>{let n=Ke(t),r=qe(e,t),i=r.length>0&&r.every(e=>typeof e==`boolean`),a=r.length>0&&r.every(e=>typeof e==`number`),o=r.length>0&&r.every(e=>e instanceof Date),s={key:t,name:n,width:ze(e,t,n),resizable:!0};return i?s.dataType=`boolean`:a?s.dataType=`number`:o&&(s.displayFormat=`dateTime`),s})}function Ye(e){let t=e.find(e=>e!=null);if(!(!t||typeof t!=`object`||Array.isArray(t)))return[`id`,`key`,`_id`,`uuid`,`rowKey`].find(e=>e in t&&t[e]!==null&&t[e]!==void 0)}function Xe(e){let t=Ye(e);if(t!==void 0)return e=>String(e?.[t]);let n=new WeakMap,r=0;return e=>{if(e==null)return``;if(typeof e!=`object`)return String(e);let t=n.get(e);return t===void 0&&(t=`r${r++}`,n.set(e,t)),t}}function Ze(e){return e.length?`Available columns: ${e.map(e=>String(e.key)).join(`, `)}.`:`the grid has no columns`}function Qe(e,t,n){Array.isArray(e)||I(`\`columns\` must be an array, but was ${L(e)}. Omit it entirely to infer the columns from the rows.`);let r=new Set,i=t.find(e=>e!=null);return e.forEach((e,t)=>{(!e||typeof e!=`object`)&&I(`columns[${t}] must be an object like { key: "name" }, but was ${L(e)}.`);let a=e.key;(typeof a!=`string`||!a.length)&&I(`columns[${t}] has no \`key\`. Every column needs one: { key: "name", name: "Name" }. The key is the property read from each row, and the column's identity everywhere in the API.`),r.has(a)&&I(`Duplicate column key "${a}" at columns[${t}]. Column keys must be unique — they identify the column in sort, filters, focus and events.`),r.add(a);let o=e;o.filter!==void 0&&et(o.filter,a),!(o.render||o.formatValue||o.isStatusColumn)&&!n?.has(a)&&i&&typeof i==`object`&&!(a in i)&&I(`Unknown column "${a}". ${Ze(Object.keys(i).map(e=>({key:e})))} If the column is computed rather than read from the row, give it a \`render\` function.`)}),$e(e,t)}function $e(e,t){if(!e.some(e=>e.width===void 0))return e;let n=Math.min(t.length,He);return e.map(e=>{if(e.width!==void 0)return e;let r=[];for(let i=0;i<n;i++){let n=t[i];if(n==null)continue;let a=w(e,n);a!=null&&r.push(a)}if(!r.length)return e;let i=e.name??String(e.key);return{...e,width:Be(r,i)}})}function et(e,t){(!e||typeof e!=`object`)&&I(`Column "${t}" has a \`filter\` that is ${L(e)}. It must be a filter definition: { name, create, label, match }.`);let n=e;(typeof n.name!=`string`||!n.name.length)&&I(`Column "${t}" has a \`filter\` with no \`name\`. The name identifies the filter type and is what persistence stores: { name: "dateRange", create, label, match }.`);for(let[e,r]of[[`create`,`create: (ctx) => ({ element, getValue })   // the popover body`],[`label`,`label: (value, column) => String(value)     // the chip's text`],[`match`,`match: (value, row, column) => boolean      // keep the row?`]])typeof n[e]!=`function`&&I(`Column "${t}" has a \`filter\` named "${n.name}" with no \`${e}\` function (it was ${L(n[e])}). Add:\n    ${r}`);for(let e of[`serialize`,`deserialize`])n[e]!==void 0&&typeof n[e]!=`function`&&I(`Column "${t}": \`filter.${e}\` must be a function, but was ${L(n[e])}. Omit it unless the value is not JSON-shaped.`)}function tt(e,t){if(e==null)return;typeof e!=`object`&&I(`\`sort\` must be an object like { key: "name", direction: "asc" }, but was ${L(e)}.`);let{key:n,direction:r}=e;return(typeof n!=`string`||!n.length)&&I(`\`sort.key\` must be a column key, but was ${L(n)}.`),t.some(e=>String(e.key)===n)||I(`Unknown column "${n}" in \`sort\`. ${Ze(t)}`),r!==`asc`&&r!==`desc`&&I(`\`sort.direction\` must be "asc" or "desc", but was ${JSON.stringify(r)}.`),{key:n,direction:r}}function nt(e,t){return e==null?[]:(Array.isArray(e)||I(`\`filters\` must be an array, but was ${L(e)}. Pass an empty array to clear the filters.`),e.map((e,n)=>{(!e||typeof e!=`object`)&&I(`\`filters[${n}]\` must be an object like { columnKey: "status", value: ["open"] }, but was ${L(e)}.`);let r=e,i=r.columnKey;(typeof i!=`string`||!i.length)&&I(`\`filters[${n}].columnKey\` must be a column key, but was ${L(i)}.`);let a=t.find(e=>String(e.key)===i);a||I(`Unknown column "${i}" in \`filters[${n}]\`. ${Ze(t)}`);let o=a.filter,s=o?o.name:r.type??a.filterType??`options`;!o&&s!==`options`&&I(`\`filters[${n}].type\` is ${JSON.stringify(s)}, but column "${i}" has no \`filter\` definition of that name — so nothing knows how to match it. Either give the column a \`filter\`, or use the built-in "options" type.`),o&&r.type!==void 0&&r.type!==o.name&&I(`\`filters[${n}].type\` is ${JSON.stringify(r.type)}, but column "${i}" is filtered by "${o.name}". Omit \`type\` — it is taken from the column.`);let c={...r,columnKey:i,columnName:r.columnName??a.name??i,type:s,displayFormat:r.displayFormat??a.displayFormat,value:r.value};return o||c.value!==void 0&&c.value!==null&&(Array.isArray(c.value)||I(`\`filters[${n}].value\` must be an array of the values to keep, but was ${L(c.value)}. For example: value: ["open", "closed"]. Omit it — or pass an empty array — to remove the filter.`),c.value=c.value.map(e=>typeof e==`object`&&e&&`value`in e?e:{value:e,label:String(e??``)})),c}))}function rt(e){(!e||typeof e!=`object`)&&I(`AVGrid.create(container, options): options is required and must be an object, but was ${L(e)}. The minimum call is AVGrid.create(el, { rows: [{ id: 1, name: "Ada" }] }).`);let t=e;if(Array.isArray(t.rows)||I(`\`rows\` must be an array, but was ${L(t.rows)}. Pass an empty array to render an empty grid: AVGrid.create(el, { rows: [] }).`),t.rowHeight!==void 0&&(typeof t.rowHeight!=`number`||!(t.rowHeight>0))&&I(`\`rowHeight\` must be a positive number of pixels, but was ${L(t.rowHeight)}. Omit it for the default of 24.`),t.getRowKey!==void 0&&typeof t.getRowKey!=`function`&&I(`\`getRowKey\` must be a function taking a row and returning a string, but was ${L(t.getRowKey)}. For example: getRowKey: (row) => String(row.id). Omit it to infer one.`),t.selected!==void 0){Array.isArray(t.selected)||I(`\`selected\` must be an array of row keys, but was ${L(t.selected)}. For example: selected: rows.slice(0, 3).map(getRowKey).`);let e=t.selected.find(e=>typeof e!=`string`);e!==void 0&&I(`\`selected\` must contain row keys as strings, but contained ${L(e)}. A row key is what getRowKey returns — not a row object or a row index.`)}let n=t.columns===void 0?Je(t.rows):Qe(t.columns,t.rows);if(tt(t.sort,n),t.persistFilters!==void 0){let e=t.persistFilters;(!e||typeof e!=`object`||typeof e.name!=`string`||!e.name.length)&&I(`\`persistFilters\` must be an object like { name: "orders" }, but was ${L(t.persistFilters)}. The name becomes the storage key.`)}return{...t,columns:n,filters:nt(t.filters,n),getRowKey:t.getRowKey??Xe(t.rows),rowHeight:t.rowHeight??24}}var it=`1`,R=e=>`Filters-${e}`,at=/^\d{4}-(0\d|1[0-2])-([0-2]\d|3[01])T([01]\d|2[0-3]):([0-5]\d):([0-5]\d)\.\d{3}Z$/;function ot(e){if(e?.name){if(e.storage)return e.storage;try{return typeof localStorage>`u`?void 0:localStorage}catch{return}}}function st(e,t){let n=typeof e==`object`&&e&&`value`in e?e.value:e;if(typeof n!=`string`||!(t||at.test(n)))return e;let r=new Date(n);return isNaN(r.getTime())?e:typeof e==`object`&&e&&`value`in e?{...e,value:r}:r}function ct(e,t){return e.map(e=>{let n=e,r=t?.find(e=>String(e.key)===n.columnKey)?.filter;if(r)return r.deserialize?{...n,value:r.deserialize(n.value)}:n;if(!Array.isArray(n.value))return n;let i=n.displayFormat===`date`||n.displayFormat===`dateTime`;return{...n,value:n.value.map(e=>st(e,i))}})}function lt(e){let t=ot(e);if(!t)return!1;try{return!!t.getItem(R(e.name))}catch{return!1}}function ut(e,t){let n=ot(e);if(!(!n||!e))try{let r=n.getItem(R(e.name));if(!r)return;let i=JSON.parse(r);if(i&&i.configVersion===`1`&&Array.isArray(i.filters))return ct(i.filters,t)}catch(t){console.warn(`av-grid: could not restore filters from ${R(e.name)}:`,t)}}function dt(e,t,n){let r=ot(t);if(!(!r||!t))try{let i=n?e.map(e=>{let t=n.find(t=>String(t.key)===e.columnKey)?.filter;return t?.serialize?{...e,value:t.serialize(e.value)}:e}):e;r.setItem(R(t.name),JSON.stringify({configVersion:`1`,filters:i}))}catch(e){console.warn(`av-grid: could not persist filters:`,e)}}function ft(e,t){return e===t?!0:!e||!t||typeof e!=`object`||typeof t!=`object`||e.label!==t.label?!1:e.value instanceof Date&&t.value instanceof Date?e.value.getTime()===t.value.getTime():e.value===t.value}function pt(e,t,n,r,i,a){let o=t.find(e=>String(e.key)===r),s=n.filter(e=>e.columnKey!==r),c=new Set;for(let n of x(e,t,a,s))c.add(o?.formatValue?o.formatValue(o,n):n?.[r]);let l=Array.from(c);l.sort(p());let u=l.map(e=>({value:e,...e==null?{italic:!0}:void 0,label:e===void 0?`(undefined)`:e===null?`(null)`:m(e,o?.displayFormat)}));if(!i)return u;let d=i.toLowerCase();return u.filter(e=>e.label.toLowerCase().includes(d))}function mt(e,t){if(e===t)return!0;if(!e||!t||typeof e!=`object`||typeof t!=`object`)return!1;try{return JSON.stringify(e)===JSON.stringify(t)}catch{return!1}}function ht(e,t){if(e===t)return!0;if(!t||e.columnKey!==t.columnKey||e.type!==t.type)return!1;let n=e.value,r=t.value;return!Array.isArray(n)||!Array.isArray(r)?mt(n,r):n.length===r.length&&n.every((e,t)=>ft(e,r[t]))}var gt=class{model;constructor(e){this.model=e;let t=ut(e.options.persistFilters,this.columns);t&&(this.model.options.filters=this.restore(t))}restore(e){let t=[];for(let n of e)try{t.push(...this.validate([n]))}catch(e){console.warn(`av-grid: dropping stored filter for column "${n?.columnKey}":`,e instanceof Error?e.message:e)}return t}get filters(){return this.model.options.filters??[]}getFilters(){return[...this.filters]}filterFor(e){return this.filters.find(t=>t.columnKey===e)}isFiltered(e){return this.filters.some(t=>t.columnKey===e)}filterOrDefault(e){return this.filterFor(e)??this.validate([{columnKey:e}])[0]}getOptions(e,t){let n=this.model.data.columns,r=this.filters.filter(t=>t.columnKey!==e),i=this.model.options.onGetOptions;return i?i(n,r,e,t):pt(this.model.options.rows,n,this.filters,e,t,this.model.options.searchString)}setFilters=e=>{let t=this.validate(e);this.same(t,this.filters)||(this.model.options.filters=t,this.filtersChanged())};applyFilter=e=>{let[t]=this.validate([e]),n=t.value;if(n==null||Array.isArray(n)&&!n.length){this.removeFilter(t.columnKey);return}let r=this.filters,i=r.some(e=>e.columnKey===t.columnKey);this.model.options.filters=i?r.map(e=>e.columnKey===t.columnKey?t:e):[...r,t],this.filtersChanged()};removeFilter=e=>{let t=this.filters,n=t.filter(t=>t.columnKey!==e);n.length!==t.length&&(this.model.options.filters=n,this.filtersChanged())};clearFilters=()=>{this.filters.length&&(this.model.options.filters=[],this.filtersChanged())};get columns(){return this.model.data.columns.length?this.model.data.columns:this.model.options.columns}validate=e=>nt(e,this.columns);same=(e,t)=>e.length===t.length&&e.every((e,n)=>ht(e,t[n]));filtersChanged=()=>{dt(this.filters,this.model.options.persistFilters,this.columns),this.model.models.rows.refilterRows(),this.model.options.onFiltersChange?.(this.getFilters()),this.model.events.onFiltersChanged.send(this.getFilters()),this.model.update({rows:[0]})}},_t=1,vt=2,yt=4,bt=8,xt=16,St=32,Ct={rowStart:-1,rowEnd:-1,colStart:-1,colEnd:-1,focusRow:-1,focusCol:-1};function wt(e,t,n){let r=0;return t>=e.rowStart&&t<=e.rowEnd&&n>=e.colStart&&n<=e.colEnd&&(r=_t,t===e.rowStart&&(r|=vt),t===e.rowEnd&&(r|=yt),n===e.colStart&&(r|=bt),n===e.colEnd&&(r|=xt)),t===e.focusRow&&n===e.focusCol&&(r|=St),r}var Tt=new Set([`ArrowDown`,`ArrowUp`,`ArrowLeft`,`ArrowRight`,`Tab`,`PageDown`,`PageUp`,`Home`,`End`]),Et=class{model;focusFromIndex=!1;_focus;ranges=Ct;constructor(e){this.model=e,this.model.data.onChange.subscribe(this.onDataChange),this.model.events.cell.onMouseDown.subscribe(this.onCellMouseDown),this.model.events.cell.onSelectMove.subscribe(this.onCellSelectMove),this.model.events.cell.onSelectEnd.subscribe(this.onSelectEnd),this.model.events.content.onKeyDown.subscribe(this.onContentKeyDown)}get focus(){return this._focus}get isDragging(){return!!this._focus?.isDragging}getGridFocus(){let{rows:e,columns:t}=this.model.data,{focusRow:n,focusCol:r}=this.ranges;if(!(n<0||r<0))return{row:e[n],column:t[r],rowIndex:n,colIndex:r}}get singleCellSelected(){let e=this.ranges;return e.focusRow>=0&&e.rowStart===e.rowEnd&&e.colStart===e.colEnd}get selectedCount(){let e=this.ranges;return e.focusRow<0?{rows:0,columns:0,minRow:0,minCol:0}:{rows:e.rowEnd-e.rowStart+1,columns:e.colEnd-e.colStart+1,minRow:e.rowStart,minCol:e.colStart}}getGridSelection(){let e=this.ranges;if(e.focusRow<0)return;let{rows:t,columns:n}=this.model.data;return{rows:t.slice(e.rowStart,e.rowEnd+1),columns:n.slice(e.colStart,e.colEnd+1),focusRow:e.focusRow,focusCol:e.focusCol,rowRange:[e.rowStart,e.rowEnd],colRange:[e.colStart,e.colEnd]}}inSelection(e,t){let n=this.ranges;return t>=n.rowStart&&t<=n.rowEnd&&e>=n.colStart&&e<=n.colEnd}focusClass=(e,t)=>{let n=this.ranges;if(n.focusRow<0)return``;let r=wt(n,t,e);if(r===0)return``;let i=``;return r&_t&&(i+=` avg-in-selection`),r&vt&&(i+=` avg-in-selection-top`),r&yt&&(i+=` avg-in-selection-bottom`),r&bt&&(i+=` avg-in-selection-left`),r&xt&&(i+=` avg-in-selection-right`),r&St&&(i+=` avg-focused`),i};focusCell=(e,t,n)=>{this.updateFocus(e,t,`click`,{withScroll:n})};selectRange=(e,t,n,r)=>{let{columns:i,rows:a}=this.model.data,o=i[t],s=i[r],c=a[e],l=a[n];if(!o||!s||c===void 0||l===void 0)return;let u=this.model.options.getRowKey;this.setFocus({columnKey:s.key,rowKey:u(l),isDragging:!1,selection:{colKeyStart:o.key,rowKeyStart:u(c),colKeyEnd:s.key,rowKeyEnd:u(l),colStart:t,rowStart:e,colEnd:r,rowEnd:n}})};focusNewRows=(e,t,n)=>{let r=this.model.models.columns.firstEditable?.index??this.model.data.columns.findIndex(e=>!e.isStatusColumn);this.selectRange(e,n?.selection?.colStart??Math.max(0,r),e+t-1,n?.selection?.colEnd??Math.max(0,r))};setFocus=e=>{this.applyFocus(()=>e)};clearFocus=()=>{this.applyFocus(()=>void 0)};applyFocus(e){let t=this._focus,n=e(t);if(n===t)return;let r=this.ranges;this._focus=n,this.ranges=this.deriveRanges(n),this.markChanged(r,this.ranges),this.model.models.editing.onFocusMoved(),this.model.options.onFocusChange?.(n),this.model.models.structure.dropUntouchedTrailingRow()}deriveRanges(e){if(!e)return Ct;let t=e.selection;if(t)return{rowStart:Math.min(t.rowStart,t.rowEnd),rowEnd:Math.max(t.rowStart,t.rowEnd),colStart:Math.min(t.colStart,t.colEnd),colEnd:Math.max(t.colStart,t.colEnd),focusRow:t.rowEnd,focusCol:t.colEnd};let n=this.model.options.getRowKey,r=this.model.data.rows.findIndex(t=>n(t)===e.rowKey),i=this.model.data.columns.findIndex(t=>t.key===e.columnKey);return r<0||i<0?Ct:{rowStart:r,rowEnd:r,colStart:i,colEnd:i,focusRow:r,focusCol:i}}markChanged(e,t){if(e===t)return;let n=this.model.renderModel;if(!n)return;let{rows:r,columns:i}=n.renderInfo.current.renderRange,a=[];for(let n=0;n<r.length;n++){let o=r[n];if(o<=0)continue;let s=o-1;for(let n=0;n<i.length;n++){let r=i[n];wt(e,s,r)!==wt(t,s,r)&&a.push({row:o,col:r})}}if(a.length){let e={cells:a};this.model.update(e)}}updateFocus(e,t,n,r){let{rows:i,columns:a}=this.model.data,o=i[e],s=a[t];if(o===void 0||s===void 0)return;let c=this.model.options.getRowKey;this.applyFocus(i=>{if(n===`drag`&&!i?.isDragging||n===`rightClick`&&this.inSelection(t,e)||n===`drag`&&i?.selection?.rowEnd===e&&i.selection.colEnd===t)return i;let a={rowKeyEnd:c(o),colKeyEnd:s.key,rowEnd:e,colEnd:t},l=n===`click`||n===`rightClick`||!i?.selection?{rowKeyStart:c(o),colKeyStart:s.key,rowStart:e,colStart:t}:{rowKeyStart:i.selection.rowKeyStart,colKeyStart:i.selection.colKeyStart,rowStart:i.selection.rowStart,colStart:i.selection.colStart};return{rowKey:a.rowKeyEnd,columnKey:a.colKeyEnd,isDragging:!!(r?.startDrag||i?.isDragging),selection:{...a,...l}}}),r?.withScroll&&this.model.renderModel?.scrollTo(this.model.dataRowToGridRow(e),t)}onDataChange=e=>{(e.rows||e.columns)&&this.validateFocus()};validateFocus=()=>{let e=this.model.options.getRowKey,{rows:t,columns:n}=this.model.data;this.applyFocus(r=>{if(!r)return r;let i=t.findIndex(t=>e(t)===r.rowKey),a=n.findIndex(e=>e.key===r.columnKey);if(i<0||a<0||this.focusFromIndex){if(this.focusFromIndex=!1,!t.length||!n.length)return;let i=Math.min(r.selection?.rowEnd??0,t.length-1),a=Math.min(r.selection?.colEnd??0,n.length-1),o=e(t[i]),s=n[a].key;return{columnKey:s,rowKey:o,isDragging:!1,selection:{colStart:a,colKeyStart:s,rowStart:i,rowKeyStart:o,colEnd:a,colKeyEnd:s,rowEnd:i,rowKeyEnd:o}}}let o=r.selection;if(!o)return r;let s=t.findIndex(t=>e(t)===o.rowKeyStart),c=n.findIndex(e=>e.key===o.colKeyStart);return s===o.rowStart&&c===o.colStart&&i===o.rowEnd&&a===o.colEnd?r:(this.model.flags.noScrollOnFocus?this.model.flags.noScrollOnFocus=!1:this.model.renderModel?.scrollToRow(this.model.dataRowToGridRow(i),`center`),{...r,selection:{...o,rowStart:i,colStart:a,rowEnd:i,colEnd:a}})})};onCellMouseDown=e=>{let t=e.e.button===0;this.updateFocus(e.rowIndex,e.colIndex,e.e.shiftKey?`shiftClick`:t?`click`:`rightClick`,{startDrag:t})};onCellSelectMove=e=>{this.updateFocus(e.rowIndex,e.colIndex,`drag`)};onSelectEnd=()=>{this._focus?.isDragging&&(this._focus={...this._focus,isDragging:!1})};onContentKeyDown=e=>{let{rows:t,columns:n}=this.model.data;if(e.ctrlKey&&e.code===`KeyA`&&t.length&&n.length){e.preventDefault(),e.stopPropagation(),this.selectRange(0,0,t.length-1,n.length-1);return}if(!Tt.has(e.key)||!t.length||!n.length)return;e.preventDefault(),e.stopPropagation();let r=this.ranges.focusRow,i=this.ranges.focusCol;if(r<0||i<0){this.updateFocus(0,0,`click`,{withScroll:!0});return}let a=this.model.renderModel?.visibleRowCount||1,o=t.length-1,s=n.length-1,c=()=>this.model.models.structure.addTrailingRow().length?(o=this.model.data.rows.length-1,!0):!1;switch(e.key){case`ArrowDown`:r===o&&!e.ctrlKey&&!e.shiftKey&&c(),r=e.ctrlKey?Math.min(o,r+a):Math.min(o,r+1);break;case`ArrowUp`:r=e.ctrlKey?Math.max(0,r-a):Math.max(0,r-1);break;case`PageDown`:r=Math.min(o,r+a);break;case`PageUp`:r=Math.max(0,r-a);break;case`End`:r=o,e.ctrlKey&&(i=s);break;case`Home`:r=0,e.ctrlKey&&(i=0);break;case`ArrowLeft`:i=e.ctrlKey?0:Math.max(0,i-1);break;case`ArrowRight`:e.ctrlKey&&i===s&&this.model.models.structure.canAddColumns&&this.model.models.structure.addBlankColumns(1).length&&(s=this.model.data.columns.length-1),i=e.ctrlKey?s:Math.min(s,i+1);break;case`Tab`:e.shiftKey?i>0?i--:(i=s,r=Math.max(0,r-1)):(i=i<s?i+1:0,i===0&&r===o&&c(),i===0&&r<o&&r++)}this.updateFocus(r,i,e.shiftKey&&e.key!==`Tab`?`shiftClick`:`click`,{withScroll:!0})}},Dt=class{model;constructor(e){this.model=e,this.model.data.onChange.subscribe(this.onDataChange),this.model.events.onRowsAdded.subscribe(this.onRowsAdded),this.model.events.onRowsDeleted.subscribe(this.onRowsDeleted)}get rowCount(){return this.model.data.rows.length+1}freezeRows=()=>{let{searchString:e,filters:t}=this.model.options;!this.model.state.get().sort&&!e?.length&&!t?.length||(this.model.data.rowsFrozen=!0,this.model.data.change(),this.model.update({rows:[0]}))};unfreezeRows=()=>{this.model.data.rowsFrozen&&(this.clearFreeze(),this.updateRows())};refilterRows=()=>{this.clearFreeze(),this.updateRows()};clearFreeze=()=>{this.model.data.rowsFrozen&&(this.model.data.rowsFrozen=!1,this.model.data.change(),this.model.update({rows:[0]}))};updateRows=()=>{if(this.model.syncSearchWords(),this.model.data.rowsFrozen){this.updateFrozenRows();return}let e=this.model.state.get().sort?.direction,t=this.model.options.rows;t=this.filter(t),t=this.sort(t,e);let n=t!==this.model.data.rows;this.model.data.rows=t,this.model.data.change(),this.model.update({all:!0}),n&&this.model.renderModel&&this.model.options.onVisibleRowsChange?.(t)};filter=e=>x(e,this.model.data.columns,this.model.options.searchString,this.model.options.filters);sort=(e,t)=>{let n=this.model.data.rowCompare;if(!n)return e;let r=this.model.data.sortValue,i;return r?i=this.sortByValue(e,r,n):(i=[...e],i.sort(n)),t===`desc`?i.reverse():i};sortByValue=(e,t,n)=>{let r=e.map(e=>({row:e,value:t(e)}));return r.sort((e,t)=>n(e.value,t.value)),r.map(e=>e.row)};onDataChange=e=>{e.rowCompare&&(this.model.data.rowsFrozen?this.unfreezeRows():this.updateRows()),e.columns&&this.updateRows(),e.rows&&this.model.requestRepaint()};updateFrozenRows=()=>{if(!this.model.data.rowsFrozen)return;let e=this.model.options.getRowKey,t=this.model.data.rows.reduce((t,n,r)=>(t[e(n)]=r,t),{}),n=[...this.model.data.rows];this.model.options.rows.forEach(r=>{let i=t[e(r)];i!==void 0&&(n[i]=r)}),this.model.data.rows=n,this.model.data.change(),this.model.update({all:!0})};onRowsAdded=({rows:e,insertIndex:t})=>{if(!this.model.data.rowsFrozen)return;let n=[...this.model.data.rows];n.splice(t??n.length,0,...e),this.model.data.rows=n};onRowsDeleted=({rowKeys:e})=>{if(!this.model.data.rowsFrozen)return;let t=this.model.options.getRowKey;this.model.data.rows=this.model.data.rows.filter(n=>!e.includes(t(n)))}},Ot=class{model;_selected;constructor(e){this.model=e,this._selected=new Set(e.options.selected??[]),this.model.data.onChange.subscribe(this.onDataChange)}get selected(){return this._selected}get count(){return this._selected.size}get allSelected(){return this.model.data.allSelected}get selectAllState(){return this.allSelected?`all`:this._selected.size>0?`some`:`none`}isSelected=e=>this._selected.has(e);getSelectedKeys(){return[...this._selected]}getSelectedRows(){if(this._selected.size===0)return[];let e=this.model.options.getRowKey;return this.model.data.rows.filter(t=>this._selected.has(e(t)))}rowClass=e=>{if(this._selected.size===0)return``;let t=this.model.data.rows[e];return t===void 0?``:this._selected.has(this.model.options.getRowKey(t))?` avg-row-selected`:``};setSelected=e=>{this.apply(new Set(e??[]))};toggleSelected=e=>{let t=new Set(this._selected);t.delete(e)||t.add(e),this.apply(t)};setRowSelected=(e,t)=>{if(this._selected.has(e)===t)return;let n=new Set(this._selected);t?n.add(e):n.delete(e),this.apply(n)};selectAll=()=>{let e=this.model.options.getRowKey,t=this.model.data.rows;this.apply(new Set(t.map(t=>e(t))),t.length>0)};deselect=e=>{if(this._selected.size===0)return;let t=new Set(this._selected),n=!1;for(let r of e)t.delete(r)&&(n=!0);n&&this.apply(t)};clearSelected=()=>{this._selected.size!==0&&this.apply(new Set,!1)};toggleAll=()=>{this.selectAllState===`none`?this.selectAll():this.clearSelected()};apply(e,t){let n=this._selected;if(kt(n,e))return;let r=this.selectAllState;this._selected=e,this.updateAllSelected(t),this.markChanged(n,e,r),this.model.options.onSelectionChange&&this.model.options.onSelectionChange(this.getSelectedKeys())}markChanged(e,t,n){let r=this.model.renderModel;if(!r)return;let i=this.model.options.getRowKey,a=this.model.data.rows,o=r.renderInfo.current.renderRange.rows,s=[];this.selectAllState!==n&&s.push(0);for(let n=0;n<o.length;n++){let r=o[n];if(r<=0)continue;let c=a[r-1];if(c===void 0)continue;let l=i(c);e.has(l)!==t.has(l)&&s.push(r)}s.length&&this.model.update({rows:s})}updateAllSelected(e){if(e!==void 0){this.model.data.allSelected=e,this.model.data.change();return}let t=this.model.options.getRowKey,n=this.model.data.rows;this.model.data.allSelected=this._selected.size>0&&this._selected.size===n.length&&n.every(e=>this._selected.has(t(e))),this.model.data.change()}onDataChange=e=>{if(!e.rows)return;let t=this.selectAllState;this.updateAllSelected(),this.selectAllState!==t&&this.model.update({rows:[0]})}};function kt(e,t){if(e===t)return!0;if(e.size!==t.size)return!1;for(let n of e)if(!t.has(n))return!1;return!0}var At=class{model;constructor(e){this.model=e,this.model.data.onChange.subscribe(this.onDataChange),this.model.events.onSortColumn.subscribe(({columnKey:e})=>this.sortColumn(e))}get sort(){return this.model.state.get().sort}sortColumn=e=>{this.model.options.disableSorting||(this.model.state.update(t=>{t.sort=t.sort?.key===e?t.sort.direction===`desc`?void 0:{key:e,direction:`desc`}:{key:e,direction:`asc`}}),this.sortChanged())};setSort=e=>{let t=this.model.state.get().sort;(t?.key!==e?.key||t?.direction!==e?.direction)&&(this.model.state.update(t=>{t.sort=e}),this.sortChanged())};sortChanged=()=>{let e=this.model.data.rowCompare,t=this.model.data.sortValue;this.updateRowCompare(),this.model.data.rowCompare===e&&this.model.data.sortValue===t&&this.model.models.rows.updateRows(),this.model.options.onSortChange?.(this.model.state.get().sort),this.model.update({rows:[0]})};onDataChange=e=>{e.columns&&this.updateRowCompare()};updateRowCompare=()=>{let e,t,n=this.model.state.get().sort;if(n){let r=this.model.data.columns.find(e=>String(e.key)===n.key);r?.rowCompare?e=r.rowCompare:r?.sortValue?(t=r.sortValue,e=p()):e=p(n.key)}this.model.data.sortValue=t,this.model.data.rowCompare=e,this.model.data.change()}},jt=class{model;nextPlaceholder=1;rowKeyProperty;addingTrailingRow=!1;constructor(e){this.model=e,this.model.events.content.onKeyDown.subscribe(this.onContentKeyDown)}addRows=(e,t,n=!1)=>{if(!e.length)return[];let r=this.model.data.rows,i=t===void 0?r.length:Math.max(0,Math.min(t,r.length));if(this.model.options.onAddRows?.({rows:e,index:i})===!1)return[];this.model.models.rows.freezeRows();let a=[...this.model.options.rows];return a.splice(this.sourceIndex(i),0,...e),this.model.options.rows=a,this.model.flags.noScrollOnFocus=!0,this.model.events.onRowsAdded.send({rows:e,insertIndex:i}),this.model.models.rows.updateRows(),n&&(this.model.models.focus.focusNewRows(i,e.length,this.model.models.focus.focus),this.model.renderModel?.scrollToRow(this.model.dataRowToGridRow(i+e.length-1))),e};addBlankRows=(e=1,t,n=!0)=>{if(e<1)return[];let r=this.model.data.rows,i=t===void 0?r.length:t,a=Array.from({length:e},(e,t)=>this.blankRow(i+t));return this.addRows(a,t,n)};addTrailingRow=()=>{if(!this.canAddRows||this.model.data.newRowKey)return[];this.addingTrailingRow=!0;try{let e=this.addBlankRows(1,void 0,!1);return e.length&&(this.model.data.newRowKey=this.model.options.getRowKey(e[0]),this.model.data.change()),e}finally{this.addingTrailingRow=!1}};dropUntouchedTrailingRow=()=>{let e=this.model.data.newRowKey;if(e===void 0||this.addingTrailingRow)return;let t=this.displayIndexOfKey(e);if(t<0){this.model.data.newRowKey=void 0,this.model.data.change();return}let{rows:n,minRow:r}=this.model.models.focus.selectedCount;n>0&&t>=r&&t<r+n||(this.model.data.newRowKey=void 0,this.model.data.change(),this.deleteRows([e]))};deleteRows=(e,t=!1)=>{if(!e.length)return!1;let n=new Set(e),r=this.model.options.getRowKey,i=[],a=[];for(let e of this.model.options.rows)(n.has(r(e))?i:a).push(e);if(!i.length||this.model.options.onDeleteRows?.({rows:i,rowKeys:i.map(r)})===!1)return!1;let{minRow:o,minCol:s}=this.model.models.focus.selectedCount;if(this.model.models.editing.isEditing&&this.model.models.editing.cancelEdit(),this.model.options.rows=a,this.model.data.newRowKey&&n.has(this.model.data.newRowKey)&&(this.model.data.newRowKey=void 0),this.model.models.selected.deselect(e),this.model.events.onRowsDeleted.send({rowKeys:e}),this.model.flags.noScrollOnFocus=!0,this.model.models.rows.updateRows(),t){let e=this.model.data.rows.length;e?this.model.models.focus.focusCell(Math.min(o,e-1),s):this.model.models.focus.clearFocus()}return!0};insertRowsAtSelection=e=>{if(!this.canAddRows)return[];let{rows:t,minRow:n}=this.model.models.focus.selectedCount;return this.addBlankRows((e??t)||1,n)};insertColumnsAtSelection=e=>{if(!this.canAddColumns)return[];let{columns:t,minCol:n}=this.model.models.focus.selectedCount;return this.addBlankColumns((e??t)||1,this.hostIndex(n))};deleteSelectedRows=()=>{let e=this.model.models.focus.getGridSelection();if(!e?.rows.length)return!1;let t=this.model.options.getRowKey;return this.deleteRows(e.rows.map(t),!0)};addColumns=(e,t)=>{if(!e.length)return[];let n=this.model.options.columns,r=t===void 0?n.length:Math.max(0,Math.min(t,n.length));if(this.model.options.onAddColumns?.({columns:e,index:r})===!1)return[];let i=[...n];return i.splice(r,0,...e),this.model.models.columns.setColumns(i),this.model.update({all:!0}),e};addBlankColumns=(e=1,t)=>{if(e<1)return[];let n=Array.from({length:e},()=>this.blankColumn());return this.addColumns(n,t)};deleteColumns=e=>{if(!e.length)return!1;let t=new Set(e),n=this.model.options.columns,r=n.filter(e=>t.has(String(e.key)));return!r.length||this.model.options.onDeleteColumns?.({columns:r,columnKeys:r.map(e=>String(e.key))})===!1?!1:(this.model.models.editing.isEditing&&this.model.models.editing.cancelEdit(),this.model.models.columns.setColumns(n.filter(e=>!t.has(String(e.key)))),this.model.update({all:!0}),!0)};deleteSelectedColumns=()=>{let e=this.model.models.focus.getGridSelection();if(!e?.columns.length)return!1;let t=e.columns.filter(e=>!e.isStatusColumn).map(e=>String(e.key));return this.deleteColumns(t)};get canAddRows(){return!!this.model.options.canAddRows}get canDeleteRows(){return!!this.model.options.canDeleteRows}get canAddColumns(){return!!this.model.options.canAddColumns}get canDeleteColumns(){return!!this.model.options.canDeleteColumns}onContentKeyDown=e=>{if(!e.ctrlKey)return;let t=e.getModifierState?.(`NumLock`)??!1;if(e.code===`Insert`||e.code===`Numpad0`&&!t){if(e.shiftKey?!this.canAddColumns:!this.canAddRows)return;e.preventDefault(),e.shiftKey?this.insertColumnsAtSelection():this.insertRowsAtSelection();return}if(e.code===`Delete`||e.code===`NumpadDecimal`&&!t){if(e.shiftKey?!this.canDeleteColumns:!this.canDeleteRows)return;e.preventDefault(),e.shiftKey?this.deleteSelectedColumns():this.deleteSelectedRows()}};sourceIndex(e){let t=this.model.data.rows,n=this.model.options.rows;if(e>=t.length)return n.length;let r=n.indexOf(t[e]);return r<0?n.length:r}displayIndexOfKey(e){let t=this.model.data.rows,n=this.model.options.getRowKey,r=t.length-1;if(r<0)return-1;if(n(t[r])===e)return r;for(let i=0;i<r;i++)if(n(t[i])===e)return i;return-1}hostIndex(e){let t=this.model.data.columns[e];if(!t)return;let n=this.model.options.columns.indexOf(t);return n<0?void 0:n}blankRow(e){let t=this.model.options.newRow;if(t)return t(e);let n={},r=this.keyProperty();return r&&(n[r]=`new-${this.nextPlaceholder++}`),n}keyProperty(){return this.rowKeyProperty===void 0&&(this.rowKeyProperty=Ye(this.model.options.rows)??null),this.rowKeyProperty??void 0}blankColumn(){let e=this.model.options.newColumn,t=this.model.options.columns.length;if(e)return e(t);let n=this.nextPlaceholder++,r=new Set(this.model.options.columns.map(e=>String(e.key)));for(;r.has(`column${n}`);)n=this.nextPlaceholder++;return{key:`column${n}`,name:`Column ${n}`}}},Mt=[],Nt=class{columns;sortColumn;filters;rows;selected;focus;editing;copyPaste;structure;constructor(e){this.columns=new ke(e),this.sortColumn=new At(e),this.filters=new gt(e),this.rows=new Dt(e),this.selected=new Ot(e),this.focus=new Et(e),this.editing=new Le(e),this.copyPaste=new Pe(e),this.structure=new jt(e)}},Pt=class extends r{options;renderModel=null;data;events=new se;models;flags={noScrollOnFocus:!1};constructor(e){super({sort:e.sort??void 0}),this.options=e,this.data=new ie([],[]),this.models=new Nt(this),this.models.columns.updateColumnsData(e.columns),this.models.rows.updateRows()}setRenderModel=e=>{this.renderModel=e};update=e=>{this.renderModel?.update(e)};requestRepaint=()=>{this.renderModel?.requestRepaint()};focusGrid=()=>{this.renderModel?.gridRef.current?.focus({preventScroll:!0})};gridRowToDataRow=e=>e-1;dataRowToGridRow=e=>e+1;rowKeyAt=e=>{let t=this.data.rows[e];return t===void 0?``:this.options.getRowKey(t)};cellContext=(e,t)=>{let n=this.data.rows[e],r=this.data.columns[t];if(n!==void 0&&r!==void 0)return{value:n[r.key],row:n,column:r,rowIndex:e,colIndex:t,rowKey:this.options.getRowKey(n),highlight:this.highlightText}};setRows=e=>{this.options.rows=e,this.models.rows.updateRows()};setColumns=e=>{this.models.columns.setColumns(e)};setSort=e=>{this.models.sortColumn.setSort(e)};setFilters=e=>{this.models.filters.setFilters(e)};setSearchString=e=>{this.options.searchString!==e&&(this.options.searchString=e,this.models.rows.refilterRows())};highlightText=e=>A(e==null?``:String(e),this.data.searchWords);syncSearchWords=()=>{this.data.searchWords=this.options.highlightSearch===!1?Mt:b(this.options.searchString)};dispose(){this.events.clear(),this.data.onChange.clear(),this.renderModel=null,super.dispose()}},Ft=class{maxSize;elements=[];_stats={hits:0,misses:0,released:0,discarded:0};constructor(e=2e3){this.maxSize=e}acquire=()=>{let e=this.elements.pop();return e?this._stats.hits++:this._stats.misses++,e};release=e=>{if(this.elements.length>=this.maxSize){this._stats.discarded++;return}this._stats.released++,this.elements.push(e)};get size(){return this.elements.length}get stats(){return this._stats}resetStats(){this._stats={hits:0,misses:0,released:0,discarded:0}}clear(){this.elements=[]}},z=(e,t)=>Array.from({length:t-e+1},(t,n)=>e+n),It=(e,t)=>z(0,t.stickyLeft-1).forEach(t=>{e.columns[t]=!0}),B=(e,t)=>z(t.columnCount-t.stickyRight,t.columnCount-1).forEach(t=>{e.columns[t]=!0}),Lt=(e,t)=>z(0,t.stickyTop-1).forEach(t=>{e.rows[t]=!0}),Rt=(e,t)=>z(1,t.stickyBottom).forEach(n=>{e.rows[t.rowCount-n]=!0}),zt=(e,t,n)=>z(Math.min(t.input.stickyTop,n.stickyTop)+1,Math.max(t.input.stickyTop,n.stickyTop)).forEach(t=>{e.rows[t-1]=!0}),Bt=(e,t,n)=>z(1,Math.max(t.input.stickyBottom,n.stickyBottom)).forEach(t=>{e.rows[n.rowCount-t]=!0}),Vt=(e,t,n)=>z(Math.min(t.input.stickyLeft,n.stickyLeft)+1,Math.max(t.input.stickyLeft,n.stickyLeft)).forEach(t=>{e.columns[t-1]=!0}),Ht=(e,t,n)=>z(1,Math.max(t.input.stickyRight,n.stickyRight)).forEach(t=>{e.columns[n.columnCount-t]=!0});function Ut(e,t,n){z(t.rendered.left,t.rendered.right).forEach(t=>{e.columns[t]=!0}),It(e,n),B(e,n)}function Wt(e,t,n){for(let n=t.rendered.top;n<=t.rendered.bottom;n++)e.rows[n]=!0;Lt(e,n),Rt(e,n)}function Gt(e,t,n){if(typeof t.columnLength==`number`)throw Error(`markDirtyWidth requires old.columnLength to be an array, not a number`);let r=!1,i=t.columnLength.findIndex((e,t)=>e!==n[t]);return i<0?!1:(i<=t.rendered.right&&(z(Math.max(i,t.rendered.left),t.rendered.right).forEach(t=>{e.columns[t]=!0}),r=!0),i<t.input.stickyLeft&&(It(e,t.input),r=!0),t.input.stickyRight&&i<=t.input.columnCount-t.input.stickyRight&&(B(e,t.input),r=!0),r)}function Kt(e,t,n){if(typeof t.rowLength==`number`)throw Error(`markDirtyHeight requires old.rowLength to be an array, not a number`);let r=!1,i=t.rowLength.findIndex((e,t)=>e!==n[t]);return i<0?!1:(i<t.rendered.bottom&&(z(Math.max(i,t.rendered.top),t.rendered.bottom).forEach(t=>{e.rows[t]=!0}),r=!0),i<t.input.stickyTop&&(Lt(e,t.input),r=!0),t.input.stickyBottom&&i<=t.input.rowCount-t.input.stickyBottom&&(Rt(e,t.input),r=!0),r)}function qt(e,t,n,r,i,a=n.fitToWidth){let o,s;if(!e)o={all:!1,rows:{},columns:{},cells:{}},s=!0;else{let n=e=>e>=t.rendered.top&&e<=t.rendered.bottom||e<t.input.stickyTop||e>=t.input.rowCount-t.input.stickyBottom,r=e=>e>=t.rendered.left&&e<=t.rendered.right||e<t.input.stickyLeft||e>=t.input.columnCount-t.input.stickyRight,i=(e.rows||[]).filter(n),a=(e.columns||[]).filter(r),c=(e.cells||[]).filter(({row:e,col:t})=>n(e)&&r(t));s=!(i.length||a.length||c.length),o={all:e.all??!1,rows:i.reduce((e,t)=>(e[t]=!0,e),{}),columns:a.reduce((e,t)=>(e[t]=!0,e),{}),cells:c.reduce((e,{row:t,col:n})=>(e[`${t}_${n}`]=!0,e),{})}}return a&&(t.input.scrollBarWidth!==n.scrollBarWidth||t.input.size.width!==n.size.width)&&(o.all=!0),o.all?o:(t.input.stickyTop!==n.stickyTop&&(zt(o,t,n),It(o,n),B(o,n),s=!1),t.input.stickyBottom!==n.stickyBottom&&(Bt(o,t,n),s=!1),t.input.stickyLeft!==n.stickyLeft&&(Vt(o,t,n),s=!1),t.input.stickyRight!==n.stickyRight&&(Ht(o,t,n),s=!1),t.input.rowCount!==n.rowCount&&(Rt(o,t.input),Rt(o,n),s=!1),t.input.columnCount!==n.columnCount&&(B(o,t.input),B(o,n),s=!1),typeof t.columnLength==`number`==(typeof r==`number`)?typeof r==`number`?t.columnLength!==r&&(Ut(o,t,n),s=!1):Gt(o,t,r)&&(s=!1):(Ut(o,t,n),s=!1),typeof t.rowLength==`number`==(typeof i==`number`)?typeof i==`number`?t.rowLength!==i&&(Wt(o,t,n),s=!1):Kt(o,t,i)&&(s=!1):(Wt(o,t,n),s=!1),s?null:o)}var Jt={visible:{top:0,right:0,bottom:0,left:0},rendered:{top:0,right:0,bottom:0,left:0},visibleOffset:{top:0,right:0,bottom:0,left:0},innerSize:{width:0,height:0,stickyTopHeight:0,stickyRightWidth:0,stickyBottomHeight:0,stickyLeftWidth:0},columnLength:[],rowLength:[],columnStarts:[],rowStarts:[],input:{size:{width:0,height:0},rowCount:0,columnCount:0,stickyTop:0,stickyRight:0,stickyBottom:0,stickyLeft:0,scrollBarWidth:0,scrollBarHeight:0,fitToWidth:!1},cells:[],stickyTop:[],stickyLeft:[],stickyRight:[],stickyBottom:[],stickyTopLeft:[],stickyTopRight:[],stickyBottomRight:[],stickyBottomLeft:[],map:{},renderRange:{rows:[],columns:[]}},Yt=20;function Xt(e){return Number(e.substring(0,e.length-1))}function Zt(e,t){let n=e.reduce((e,t)=>e+(typeof t==`number`?t:0),0),r=e.reduce((e,t)=>e+(typeof t==`string`?Xt(t):0),0),i=e.reduce((e,t,n)=>typeof t==`string`?n:e,-1),a=Math.max(0,t-n),o=r>0?a/r:0;return e.map((e,t)=>{if(typeof e==`string`){if(t===i)return a;let n=Math.trunc(Xt(e)*o);return a=Math.max(0,a-n),n}return e})}function Qt(e,t,n=!1,r=0){if(typeof t==`number`)return t;let i=Array.from({length:e},(e,n)=>t(n));return Array.isArray(i)&&(n||i.some(e=>typeof e==`string`))?Zt(i,r):i}function $t(e,t){if(typeof t==`number`)return!1;for(let n=0;n<e;n++)if(typeof t(n)==`string`)return!0;return!1}function en(e){if(typeof e==`number`)return e;let t=[...e];return t.forEach((n,r)=>{t[r]=r===0?0:t[r-1]+e[r-1]}),t}function V(e,t,n=1){if(typeof e==`number`)return n*e;let r=0;for(let i=t;i<t+n;i++)r+=e[i];return r}function tn(e,t){return typeof e==`number`?e:e[t]}function H(e,t){return typeof e==`number`?t*e:e[t]}function nn(e,t,n=!0){if(typeof e==`number`)return Math.trunc(t/e);let r=n?e.length-1:-1,i=0;for(let n=0;n<e.length;n++)if(i+=e[n],i>t){r=n;break}return r}var rn=(e,t,n,r,i,a,o,s,c,l,u)=>({width:V(o,0,t)+(r||c?0:u??20),height:V(s,0,e)+(i?0:l??20),stickyTopHeight:V(s,0,n),stickyRightWidth:V(o,t-r,r),stickyBottomHeight:V(s,e-i,i),stickyLeftWidth:V(o,0,a)});function an(e,t,n,r,i,a,o,s,c,l,u,d,f,p){let m=nn(l,a.x+e.stickyLeftWidth),h=nn(l,a.x+r-d);m=Math.max(0,m),h=Math.min(h,n-1);let g=nn(u,a.y+e.stickyTopHeight),_=nn(u,a.y+i-e.stickyBottomHeight-f);g=Math.max(0,g),_=Math.min(_,t-1);let v={top:c.y<0?Math.max(0,g-s):g,right:c.x>0?Math.min(n-1,h+o):h,bottom:c.y>0?Math.min(t-1,_+s):_,left:c.x<0?Math.max(0,m-o):m};return p&&p(v),{visible:{top:g,right:h,bottom:_,left:m},rendered:v}}var on=(e,t,n,r,i,a,o,s,c)=>({left:H(i,e.left)-o.stickyLeftWidth,right:V(n,0,e.right+1)-(a.width-o.stickyRightWidth-s),top:H(r,e.top)-o.stickyTopHeight,bottom:V(t,0,e.bottom+1)-(a.height-o.stickyBottomHeight-c)}),U=(e,t,n,r=0,i=0)=>{let{renderCell:a,recycle:o,old:s,newInfo:c,rerender:l,rowLength:u,columnLength:d,rowStarts:f,columnStarts:p}=e,m=`${t}_${n}`,h=s.map[m],g=h;return(!g||l&&(l.all||l.cells[m]||l.columns[n]||l.rows[t]))&&(g=a?.({col:n,row:t,style:{display:`inline-flex`,position:`absolute`,left:i?V(d,i,n-i):H(p,n),width:tn(d,n),top:r?V(u,r,t-r):H(f,t),height:tn(u,t)},key:m,renderInfo:c,recycle:o,previous:h})),c.map[m]=g,c.renderRange.rows.indexOf(t)<0&&c.renderRange.rows.push(t),c.renderRange.columns.indexOf(n)<0&&c.renderRange.columns.push(n),g};function sn(e,t,n,r){let{offset:i,size:a,rowCount:o,columnCount:s,rowHeight:c,columnWidth:l,renderCell:u,stickyTop:d=0,stickyLeft:f=0,stickyRight:p=0,stickyBottom:m=0,overscanColumn:h,overscanRow:g,scrollBarWidth:_,scrollBarHeight:v,direction:y={x:0,y:0},fitToWidth:b,onAdjustRenderRange:x}=t,{rerender:S}=t;if(!S&&(y.x||y.y)&&e.visibleOffset&&i.x>=e.visibleOffset.left&&i.x<=e.visibleOffset.right&&i.y>=e.visibleOffset.top&&i.y<=e.visibleOffset.bottom)return e;let C=b||$t(s,l),w=Qt(s,l,b,a.width-_),T=Qt(o,c),E=rn(o,s,d,p,m,f,w,T,C,n,r),D=an(E,o,s,a.width,a.height,i,h,g,y,w,T,_,v,x),ee;if(e.rendered.top||e.rendered.bottom){if(ee=qt(S,e,t,w,T,C),!S&&D.visible.left>=e.visible.left&&D.visible.right<=e.visible.right&&D.visible.top>=e.visible.top&&D.visible.bottom<=e.visible.bottom&&E.width===e.innerSize.width&&E.height===e.innerSize.height&&E.stickyTopHeight===e.innerSize.stickyTopHeight&&E.stickyRightWidth===e.innerSize.stickyRightWidth&&E.stickyBottomHeight===e.innerSize.stickyBottomHeight&&E.stickyLeftWidth===e.innerSize.stickyLeftWidth)return e}else ee={all:!0,cells:{},columns:{},rows:{}};let O=en(w),k=en(T);D.visibleOffset=on(D.visible,T,w,k,O,a,E,_,v);let A={...D,innerSize:E,columnLength:w,rowLength:T,columnStarts:O,rowStarts:k,input:{size:a,rowCount:o,columnCount:s,stickyTop:d,stickyRight:p,stickyBottom:m,stickyLeft:f,scrollBarWidth:_,scrollBarHeight:v,fitToWidth:b},cells:[],stickyTop:[],stickyLeft:[],stickyRight:[],stickyBottom:[],stickyTopLeft:[],stickyTopRight:[],stickyBottomRight:[],stickyBottomLeft:[],map:{},renderRange:{rows:[],columns:[]}},j={renderCell:u,recycle:t.recycle,old:e,newInfo:A,rerender:ee,rowLength:T,columnLength:w,rowStarts:k,columnStarts:O};for(let e=A.rendered.top;e<=A.rendered.bottom;e++)for(let t=A.rendered.left;t<=A.rendered.right;t++)e<d||t<f||e>=o-m||t>=s-p||A.cells.push(U(j,e,t));for(let e=0;e<d;e++){for(let t=0;t<f;t++)A.stickyTopLeft.push(U(j,e,t));for(let t=Math.max(f,A.rendered.left);t<=Math.min(A.rendered.right,s-p-1);t++)A.stickyTop.push(U(j,e,t));for(let t=s-p;t<s;t++)A.stickyTopRight.push(U(j,e,t,0,s-p))}for(let e=o-m;e<o;e++){for(let t=0;t<f;t++)A.stickyBottomLeft.push(U(j,e,t,o-m,0));for(let t=Math.max(f,A.rendered.left);t<=Math.min(A.rendered.right,s-p-1);t++)A.stickyBottom.push(U(j,e,t,o-m,0));for(let t=s-p;t<s;t++)A.stickyBottomRight.push(U(j,e,t,o-m,s-p))}for(let e=Math.max(d,A.rendered.top);e<=Math.min(A.rendered.bottom,o-m-1);e++){for(let t=0;t<f;t++)A.stickyLeft.push(U(j,e,t,d,0));for(let t=s-p;t<s;t++)A.stickyRight.push(U(j,e,t,d,s-p))}return A}function cn(e,t,n){let r={left:H(t.columnStarts,e),right:V(t.columnLength,0,e+1)},i=t.input.size,a={...n},o=i.width-t.innerSize.stickyRightWidth-t.input.scrollBarWidth;return a.x+o<r.right?a.x=r.right-o:a.x>r.left-t.innerSize.stickyLeftWidth&&(a.x=r.left-t.innerSize.stickyLeftWidth),a}function ln(e,t,n,r=`nearest`){let i={top:H(t.rowStarts,e),bottom:V(t.rowLength,0,e+1)},a=t.input.size,o={...n};if(e>=t.input.rowCount-1)return o.y=t.innerSize.height-t.input.size.height+t.input.scrollBarHeight,o;let s=a.height-t.innerSize.stickyBottomHeight-t.input.scrollBarHeight;return r===`nearest`?o.y+s<i.bottom?o.y=i.bottom-s:o.y>i.top-t.innerSize.stickyTopHeight&&(o.y=i.top-t.innerSize.stickyTopHeight):r===`top`?o.y=i.top-t.innerSize.stickyTopHeight:r===`bottom`?o.y=i.bottom-s:r===`center`&&(o.y=i.top-t.innerSize.stickyTopHeight+(i.bottom-i.top-s)/2,o.y+s<i.bottom?o.y=i.bottom-s:o.y>i.top&&(o.y=i.top-t.innerSize.stickyTopHeight)),o}function un(e,t,n,r){return ln(e,n,cn(t,n,r))}var dn=class{current;resolveAsync;async;constructor(e){this.current=e,this.async=new Promise(e=>{this.resolveAsync=t=>{this.resolveAsync=void 0,e(t)}})}ref=e=>{e&&this.current!==e&&(this.current=e,this.resolveAsync?this.resolveAsync(e):this.async=Promise.resolve(e))}},fn=24,pn=120,mn=0,hn={renderDt:0},gn=class extends r{gridRef=new dn(void 0);containerRef=new dn(void 0);renderInfo=new dn(Jt);offset={x:0,y:0};size={width:void 0,height:void 0};options;oldInput;pendingRerender;updateScheduled=!1;resizeObserver;_disposed=!1;scrollLost=!1;constructor(e){super({...hn}),this.options=e,this.inputChanged()}get disposed(){return this._disposed}getOptions(){return this.options}setOptions=e=>{this._disposed||(this.options={...this.options,...e},this.inputChanged()&&this.updateRenderInfo({all:!0}))};get rowCount(){return typeof this.options.rowCount==`function`?this.options.rowCount():this.options.rowCount}get columnCount(){return typeof this.options.columnCount==`function`?this.options.columnCount():this.options.columnCount}get scrollBarWidth(){let e=this.containerRef.current;return e?e.offsetWidth-e.clientWidth:0}get scrollBarHeight(){let e=this.containerRef.current;return e?e.offsetHeight-e.clientHeight:0}get visibleRowCount(){let e=this.renderInfo.current.visible;return e?e.bottom-e.top+1:0}attach=({grid:e,container:t})=>{this._disposed||(this.gridRef.ref(e),this.containerRef.ref(t),typeof ResizeObserver<`u`&&(this.resizeObserver=new ResizeObserver(()=>this.checkSize()),this.resizeObserver.observe(e)),this.checkSize())};dispose(){this._disposed=!0,this.resizeObserver?.disconnect(),this.resizeObserver=void 0,super.dispose()}requestRepaint=()=>{this._disposed||this.state.update(e=>{e.renderDt=Date.now()})};checkSize=()=>{this._disposed||this.onFrameResize()};onFrameResize=()=>{let e=this.gridRef.current,t={width:e?.offsetWidth,height:e?.offsetHeight};if(!t.width&&!t.height&&(this.offset.x||this.offset.y)&&(this.scrollLost=!0),(this.size.width!==t.width||this.size.height!==t.height||this.scrollBarWidth!==this.oldInput?.scrollBarWidth)&&(this.size=t,this.inputChanged()?this.updateRenderInfo({all:!0}):this.requestRepaint(),this.options.onResize)){let e=this.options.onResize;Promise.resolve().then(()=>e(t))}};inputChanged(){let e={rowCount:this.rowCount,columnCount:this.columnCount,rowHeight:this.options.rowHeight??24,columnWidth:this.options.columnWidth,renderCell:this.options.renderCell,stickyTop:this.options.stickyTop??0,stickyLeft:this.options.stickyLeft??0,stickyRight:this.options.stickyRight??0,stickyBottom:this.options.stickyBottom??0,overscanColumn:this.options.overscanColumn??mn,overscanRow:this.options.overscanRow??0,fitToWidth:this.options.fitToWidth??!1,size:this.size,offset:this.offset,scrollBarWidth:this.scrollBarWidth,scrollBarHeight:this.scrollBarHeight},t=this.oldInput||{};return this.oldInput=e,e.rowCount!==t.rowCount||e.columnCount!==t.columnCount||e.rowHeight!==t.rowHeight||e.columnWidth!==t.columnWidth||e.renderCell!==t.renderCell||e.stickyTop!==t.stickyTop||e.stickyLeft!==t.stickyLeft||e.stickyRight!==t.stickyRight||e.stickyBottom!==t.stickyBottom||e.overscanColumn!==t.overscanColumn||e.overscanRow!==t.overscanRow||e.fitToWidth!==t.fitToWidth||!e.size||!t.size||e.size.width!==t.size.width||e.size.height!==t.size.height||e.scrollBarWidth!==t.scrollBarWidth||e.scrollBarHeight!==t.scrollBarHeight}mergeRerenders=(e,t)=>{if(!e&&!t)return;let{all:n=!1,cells:r=[],rows:i=[],columns:a=[]}=e||{},{all:o=!1,cells:s=[],rows:c=[],columns:l=[]}=t||{};return{all:n||o,cells:[...r,...s],rows:[...i,...c],columns:[...a,...l]}};update=e=>{this._disposed||(this.pendingRerender=this.mergeRerenders(e,this.pendingRerender),e&&e.force?this.updateRenderInfo():this.updateScheduled||(this.updateScheduled=!0,Promise.resolve().then(()=>{this.updateScheduled=!1,!this._disposed&&this.pendingRerender&&this.updateRenderInfo()})))};updateRenderInfo=(e,t,n)=>{if(this._disposed)return;let{rowHeight:r=24,columnWidth:i,renderCell:a,stickyTop:o,stickyLeft:s,stickyRight:c,stickyBottom:l,overscanColumn:u=mn,overscanRow:d,fitToWidth:f=!1,onAdjustRenderRange:p}=this.options,m=this.mergeRerenders(e,this.pendingRerender),h=this.renderInfo.current===Jt?void 0:t,g=sn(this.renderInfo.current,{rowCount:this.rowCount,columnCount:this.columnCount,rowHeight:r,columnWidth:i,renderCell:a,recycle:this.options.recycle,stickyTop:o??0,stickyLeft:s??0,stickyRight:c??0,stickyBottom:l??0,overscanColumn:u,overscanRow:d??0,fitToWidth:f,size:{width:this.size.width||0,height:this.size.height||0},offset:this.offset,scrollBarWidth:this.scrollBarWidth,scrollBarHeight:this.scrollBarHeight,rerender:m,direction:h,onAdjustRenderRange:p},this.options.whiteSpaceY,this.options.whiteSpaceX);if(g.innerSize.height<(this.size.height??0)&&this.offset.y>0){this.offset.y=0,this.updateRenderInfo(e,t,n);return}if(this.pendingRerender=void 0,g!==this.renderInfo.current){let e=this.renderInfo.current;this.renderInfo.ref(g),this.renderInfoChanged(n,e,g)}};async renderInfoChanged(e,t,n){e||this.requestRepaint();let r=await this.containerRef.async;!this._disposed&&r&&(this.renderInfo.current.input.scrollBarWidth!==this.scrollBarWidth||this.renderInfo.current.input.scrollBarHeight!==this.scrollBarHeight)&&this.requestRepaint(),this.notifyChanges(t,n)}notifyChanges(e,t){this.options.onInnerSizeChange&&(e.innerSize.height!==t.innerSize.height||e.innerSize.width!==t.innerSize.width)&&this.options.onInnerSizeChange(t.innerSize)}onScroll=e=>{let t=this.containerRef.current;if(!t||e&&e.target!==t||!t.offsetHeight&&!t.offsetWidth)return;let{scrollLeft:n,scrollTop:r}=t,i={x:n-this.offset.x,y:r-this.offset.y};this.offset={x:n,y:r},this.updateRenderInfo(void 0,i)};get scrollNeedsRestore(){return this.scrollLost}restoreScroll=()=>{this.scrollLost=!1;let e=this.containerRef.current;e&&(this.offset.x!==0||this.offset.y!==0)&&(e.scrollLeft=this.offset.x,e.scrollTop=this.offset.y)};async scrollTo(e,t){let n=await this.containerRef.async,r=un(e,t,await this.renderInfo.async,this.offset);n&&(n.scrollLeft=r.x,n.scrollTop=r.y)}async scrollToRow(e,t=`nearest`){let n=await this.containerRef.async,r=ln(e,await this.renderInfo.async,this.offset,t);n&&(n.scrollTop=r.y)}async scrollToCol(e){let t=await this.containerRef.async,n=cn(e,await this.renderInfo.async,this.offset);t&&(t.scrollLeft=n.x)}async scrollBy({x:e=0,y:t=0}){let n=await this.containerRef.async,r=await this.renderInfo.async,i=r.innerSize.width-r.input.size.width+r.input.scrollBarWidth,a=r.innerSize.height-r.input.size.height+r.input.scrollBarHeight;e!==0&&n&&(n.scrollLeft=Math.min(i,n.scrollLeft+e)),t!==0&&n&&(n.scrollTop=Math.min(a,n.scrollTop+t))}},W=e=>`${e}px`;function G(e,t,n){e.style.getPropertyValue(t)!==n&&e.style.setProperty(t,n)}function K(e){let t=document.createElement(`div`);return t.setAttribute(`data-type`,e),t}var _n=new Set([`stickyLeft`,`stickyRight`,`stickyTopLeft`,`stickyTopRight`,`stickyBottomLeft`,`stickyBottomRight`]),vn=class{host;options;model;pool=new Ft;root;container;area;regions;attached;unsubscribe;rafId;paintScheduled=!1;destroyed=!1;lastInfo;lastScrollBarWidth=-1;lastScrollBarHeight=-1;_stats={paints:0,cellsAppended:0,cellsRemoved:0,lastPaintMs:0,totalPaintMs:0};constructor(e,t){this.host=e,this.options=t,this.root=K(`render-grid`),t.name&&this.root.setAttribute(`data-name`,t.name),t.className&&(this.root.className=t.className),this.container=K(`render-grid-scroll`),this.container.tabIndex=-1,this.area=K(`render-grid-area`),this.regions={cells:this.area,stickyTop:K(`render-grid-sticky-top`),stickyBottom:K(`render-grid-sticky-bottom`),stickyLeft:K(`render-grid-sticky-left`),stickyRight:K(`render-grid-sticky-right`),stickyTopLeft:K(`render-grid-sticky-top-left`),stickyTopRight:K(`render-grid-sticky-top-right`),stickyBottomLeft:K(`render-grid-sticky-bottom-left`),stickyBottomRight:K(`render-grid-sticky-bottom-right`)},this.attached={cells:new Set,stickyTop:new Set,stickyBottom:new Set,stickyLeft:new Set,stickyRight:new Set,stickyTopLeft:new Set,stickyTopRight:new Set,stickyBottomLeft:new Set,stickyBottomRight:new Set},this.regions.stickyTop.append(this.regions.stickyTopLeft,this.regions.stickyTopRight),this.regions.stickyBottom.append(this.regions.stickyBottomLeft,this.regions.stickyBottomRight),this.area.append(this.regions.stickyTop,this.regions.stickyBottom,this.regions.stickyLeft,this.regions.stickyRight),this.container.append(this.area),this.root.append(this.container),this.applyStaticStyles(),this.host.append(this.root),this.model=new gn({...t,recycle:this.pool.acquire}),this.container.addEventListener(`scroll`,this.model.onScroll,{passive:!0}),this.unsubscribe=this.model.state.subscribe(this.onModelChanged),this.model.attach({grid:this.root,container:this.container}),this.paint()}get stats(){return{...this._stats,pool:this.pool.stats}}addOverlay(e,t=`content`){this.regions[t===`header`?`stickyTop`:`cells`].append(e)}setOptions(e){Object.assign(this.options,e),this.model.setOptions(e),e.className!==void 0&&(this.root.className=e.className)}destroy(){if(!this.destroyed){this.destroyed=!0,this.container.removeEventListener(`scroll`,this.model.onScroll),this.unsubscribe?.(),this.unsubscribe=void 0,this.rafId!==void 0&&(cancelAnimationFrame(this.rafId),this.rafId=void 0),this.model.dispose(),this.pool.clear();for(let e of Object.keys(this.attached))this.attached[e].clear();this.root.remove()}}onModelChanged=e=>{this.schedulePaint()};schedulePaint(){this.destroyed||this.paintScheduled||(this.paintScheduled=!0,this.rafId=requestAnimationFrame(()=>{this.rafId=void 0,this.paintScheduled=!1,this.paint()}))}paint(){if(this.destroyed)return;let e=this.model.renderInfo.current,t=this.model.scrollBarWidth,n=this.model.scrollBarHeight;if(e===this.lastInfo&&t===this.lastScrollBarWidth&&n===this.lastScrollBarHeight)return;this.lastInfo=e,this.lastScrollBarWidth=t,this.lastScrollBarHeight=n,this._stats.paints++;let r=performance.now();this.applyLayout(e,t,n),this.syncRegion(`cells`,e.cells),this.syncRegion(`stickyTop`,e.stickyTop),this.syncRegion(`stickyBottom`,e.stickyBottom),this.syncRegion(`stickyLeft`,e.stickyLeft),this.syncRegion(`stickyRight`,e.stickyRight),this.syncRegion(`stickyTopLeft`,e.stickyTopLeft),this.syncRegion(`stickyTopRight`,e.stickyTopRight),this.syncRegion(`stickyBottomLeft`,e.stickyBottomLeft),this.syncRegion(`stickyBottomRight`,e.stickyBottomRight),this.model.scrollNeedsRestore&&this.model.restoreScroll(),this._stats.lastPaintMs=performance.now()-r,this._stats.totalPaintMs+=this._stats.lastPaintMs}resetStats(){this._stats={paints:0,cellsAppended:0,cellsRemoved:0,lastPaintMs:0,totalPaintMs:0},this.pool.resetStats()}syncRegion(e,t){let n=this.regions[e],r=this.attached[e],i=new Set;for(let e of t)e&&i.add(e);for(let e of r)i.has(e)||(n.removeChild(e),this.pool.release(e),this._stats.cellsRemoved++);for(let e of i)r.has(e)||(n.append(e),this._stats.cellsAppended++);this.attached[e]=i}applyStaticStyles(){let{growToHeight:e,growToWidth:t}=this.options;G(this.root,`flex`,`1 1 auto`),G(this.root,`position`,`relative`),G(this.root,`overflow`,`hidden`),G(this.root,`height`,this.options.height??(e?`unset`:`100px`)),G(this.root,`max-height`,e??`unset`),G(this.container,`overflow-y`,`auto`),G(this.container,`overflow-x`,this.options.fitToWidth?`hidden`:`auto`),G(this.container,`outline`,`none`),G(this.container,`overflow-anchor`,`none`),G(this.area,`overflow-anchor`,`none`),G(this.container,`max-height`,e??`unset`),G(this.container,`max-width`,t??`unset`),G(this.area,`position`,`relative`);for(let e of[`stickyTop`,`stickyBottom`])G(this.regions[e],`position`,`sticky`),G(this.regions[e],`z-index`,`2`);for(let e of[`stickyLeft`,`stickyRight`])G(this.regions[e],`position`,`sticky`),G(this.regions[e],`display`,`inline-flex`),G(this.regions[e],`z-index`,`1`);for(let e of[`stickyTopLeft`,`stickyTopRight`,`stickyBottomLeft`,`stickyBottomRight`])G(this.regions[e],`position`,`sticky`),G(this.regions[e],`display`,`inline-flex`),G(this.regions[e],`z-index`,`3`)}applyLayout(e,t,n){let{innerSize:r}=e,i=this.model.getOptions(),a=this.model.size.width??0,o=this.model.size.height??0,{growToHeight:s,growToWidth:c}=this.options;G(this.container,`width`,c?`unset`:W(a)),G(this.container,`height`,s?`unset`:W(o)),G(this.area,`width`,W(r.width)),G(this.area,`height`,W(r.height));let l=W(a-r.stickyRightWidth-t);if(this.toggleRegion(`stickyTop`,!!i.stickyTop),i.stickyTop){let e=this.regions.stickyTop;G(e,`top`,`0px`),G(e,`width`,W(r.width)),G(e,`height`,W(r.stickyTopHeight))}if(this.toggleRegion(`stickyTopLeft`,!!(i.stickyTop&&i.stickyLeft)),i.stickyTop&&i.stickyLeft){let e=this.regions.stickyTopLeft;G(e,`left`,`0px`),G(e,`width`,W(r.stickyLeftWidth)),G(e,`height`,W(r.stickyTopHeight))}if(this.toggleRegion(`stickyTopRight`,!!(i.stickyTop&&i.stickyRight)),i.stickyTop&&i.stickyRight){let e=this.regions.stickyTopRight;G(e,`left`,l),G(e,`width`,W(r.stickyRightWidth)),G(e,`height`,W(r.stickyTopHeight))}if(this.toggleRegion(`stickyBottom`,!!i.stickyBottom),i.stickyBottom){let e=this.regions.stickyBottom;G(e,`top`,W(o-r.stickyBottomHeight-n)),G(e,`width`,W(r.width)),G(e,`height`,W(r.stickyBottomHeight))}if(this.toggleRegion(`stickyBottomLeft`,!!(i.stickyBottom&&i.stickyLeft)),i.stickyBottom&&i.stickyLeft){let e=this.regions.stickyBottomLeft;G(e,`left`,`0px`),G(e,`width`,W(r.stickyLeftWidth)),G(e,`height`,W(r.stickyBottomHeight))}if(this.toggleRegion(`stickyBottomRight`,!!(i.stickyBottom&&i.stickyRight)),i.stickyBottom&&i.stickyRight){let e=this.regions.stickyBottomRight;G(e,`left`,l),G(e,`width`,W(r.stickyRightWidth)),G(e,`height`,W(r.stickyBottomHeight))}if(this.toggleRegion(`stickyLeft`,!!i.stickyLeft),i.stickyLeft){let e=this.regions.stickyLeft;G(e,`left`,`0px`),G(e,`width`,W(r.stickyLeftWidth)),G(e,`height`,W(r.height-(r.stickyTopHeight+(r.stickyBottomHeight||20)))),G(e,`transform`,`translate(0, -${r.stickyBottomHeight}px)`)}if(this.toggleRegion(`stickyRight`,!!i.stickyRight),i.stickyRight){let e=this.regions.stickyRight;G(e,`left`,l),G(e,`width`,W(r.stickyRightWidth)),G(e,`height`,W(r.height-(r.stickyTopHeight+r.stickyBottomHeight))),G(e,`transform`,`translate(0, -${r.stickyBottomHeight}px)`)}}toggleRegion(e,t){G(this.regions[e],`display`,t?_n.has(e)?`inline-flex`:`block`:`none`)}},yn=`av-grid-styles`,bn=`
