/* d3-graph.min.js — vendored subset of D3 v7 for the Force Graph board.
 * Concatenated official UMD dist builds, in dependency order. Each module
 * attaches its exports to the shared `window.d3` global.
 * Modules and versions: see VERSION.txt. License: ISC, see LICENSE.
 * Built from the official npm dist/*.min.js files — do not hand-edit.
 */
